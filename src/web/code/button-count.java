// Unread
button("View issues").primary().addBadge(badge(7).unread());
button("View issues").secondary().addBadge(badge(7).unread());
button("View issues").tertiary().addBadge(badge(7).unread());
button("View issues").control().addBadge(badge(7).unread());
button("View issues").link().addBadge(badge(7).unread()));

// Unread disabled
button("View issues").primary().disabled().addBadge(badge(7).unread());
button("View issues").secondary().disabled().addBadge(badge(7).unread());
button("View issues").tertiary().disabled().addBadge(badge(7).unread());
button("View issues").control().disabled().addBadge(badge(7).unread());
