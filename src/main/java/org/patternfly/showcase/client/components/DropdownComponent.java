...
public class DropdownComponent extends BaseComponent {
    ...
    public DropdownComponent() {
        super("Dropdown",
                p().textContent("Use a dropdown when you want to present a list of actions in a limited space.").element(),
                asList(new Snippet("Simple dropdown", "Resources.get().dropdownSimple().getText()", () -> {
                    ...
                    return div().add(dropdown).add(" ").add(Dropdown.<String> text("Dropdown").disable()).element();
                         ...
                         * .add(Dropdown.<String>group("Group 1") .add("Group 1 item 1") .add("Group 1 item 2"))
                         * .add(Dropdown.<String>group("Group 2") .add("Group 2 item 1") .add("Group 2 item 2")) // this item is
                         * added to the unnamed group above! .add("Item 3");
                        ...
                        new Snippet("Dropdown typed", "Resources.get().dropdownTyped().getText()", () -> div().add(Dropdown
                                .<Color> text("Dropdown")
