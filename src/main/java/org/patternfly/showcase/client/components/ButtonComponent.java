...
public class ButtonComponent extends ComponentPage {
    ...
    public ButtonComponent() {
        ...
        addSnippet(new Snippet("Button variations", "Resources.get().buttonVariations().getText()", () -> div()
        ...
        addSnippet(new Snippet("Button states", "Resources.get().buttonStates().getText()", () -> div()
        ...
        addSnippet(new Snippet("Links as buttons", "Resources.get().buttonLinks().getText()", () -> div()
        ...
        addSnippet(new Snippet("Button types", "Resources.get().buttonTypes().getText()", () -> div()
        ...
        addSnippet(new Snippet("Button event", "Resources.get().buttonEvent().getText()", () -> div()
