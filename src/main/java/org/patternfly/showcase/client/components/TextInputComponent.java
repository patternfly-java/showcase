...
import org.patternfly.components.form.TextInput;

import static org.jboss.elemento.Elements.div;
import static org.jboss.elemento.Elements.p;
import static org.patternfly.components.form.Checkbox.checkbox;
import static org.patternfly.components.form.TextInput.textInput;
    ...
    public TextInputComponent() {
        ...
        addSnippet(new Snippet("readonly-text-input", "Read only", "No code yet", () -> div()
                .add(div().css(util("mb-sm"))
                        .add(plainToggle.onChange(readOnlyTextInput::plain)))
