...
import static org.patternfly.components.menu.MenuItem.actionMenuItem;
import static org.patternfly.components.menu.MenuItem.checkboxMenuItem;
import static org.patternfly.components.menu.MenuItem.linkMenuItem;
                                ...
                                .addGroup(menuGroup("All actions")
                                        .addList(menuList()
                                                .addItem(actionMenuItem("item-0", "Item 1")
                                                        ...
                                                        .addAction(menuItemAction("action-0", fas(bars))))
                                                .addItem(actionMenuItem("item-1", "Item 2")
                                                ...
                                                .addItem(actionMenuItem("item-2", "Item 3")
                                                        ...
                                                        .addAction(menuItemAction("action-2", fas(bell))))))))
                .element()));
    }
}
