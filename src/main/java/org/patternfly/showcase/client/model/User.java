...
public class User {
    ...
    public final HTMLElement contact() {
        return ul()
                .add(li().add(a("mailto:" + email).add(i().css(fas("envelope"), util("mr-sm"))).add(email)))
                .add(li().add(a("tel:" + phone).add(i().css(fas("phone"), util("mr-sm"))).add(phone)))
                .add(li().add(a("tel:" + cell).add(i().css(fas("mobile-alt"), util("mr-sm"))).add(cell))).element();
    }
