...
public class MastheadComponent extends SnippetPage {
    ...
    public MastheadComponent() {
        ...
        addSnippet(new Snippet("masthead-mixed-content", "Basic with mixed content",
                code.get("masthead-mixed-content"), () ->
