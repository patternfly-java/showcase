...
public class TabsComponent extends SnippetPage {
    ...
    public TabsComponent() {
        ...
        addSnippet(new Snippet("tabs-overflow-default", "Default overflow tabs",
                code.get("tabs-overflow-default"), () -> {
