goog.module('org.patternfly.showcase.Page.$LambdaAdaptor$impl');
...
class $LambdaAdaptor extends j_l_Object {
 ...
 constructor(/** ?function():Iterable<HTMLElement> */ fn) {
  ...
  this.f_fn__org_patternfly_showcase_Page_$LambdaAdaptor;
  this.$ctor__org_patternfly_showcase_Page_$LambdaAdaptor__org_patternfly_showcase_Page_$JsFunction__void(fn);
 }
 /** @nodts */
 $ctor__org_patternfly_showcase_Page_$LambdaAdaptor__org_patternfly_showcase_Page_$JsFunction__void(/** ?function():Iterable<HTMLElement> */ fn) {
  this.$ctor__java_lang_Object__void();
  this.f_fn__org_patternfly_showcase_Page_$LambdaAdaptor = fn;
 }
 /** @override @nodts @return {Iterable<HTMLElement>} */
 m_elements__java_lang_Iterable() {
  let /** ?function():Iterable<HTMLElement> */ $function;
  return ($function = this.f_fn__org_patternfly_showcase_Page_$LambdaAdaptor, $function());
 }
...
$Util.$setClassMetadata($LambdaAdaptor, 'org.patternfly.showcase.Page$$LambdaAdaptor');
