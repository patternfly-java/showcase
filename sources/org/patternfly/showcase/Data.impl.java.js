...
class Data extends j_l_Object {
 ...
 static $clinit() {
  ...
  Data.$loadModules();
  j_l_Object.$clinit();
  Data.$static_components__org_patternfly_showcase_Data = /**@type {Object<string, Object>}*/ (Js.m_cast__java_lang_Object__java_lang_Object(goog.global.JSON.parse(ShowcaseBundleImpl.f_INSTANCE__org_patternfly_showcase_ShowcaseBundleImpl.m_components__org_treblereel_j2cl_processors_common_resources_TextResource().m_getText__java_lang_String())));
  Data.$static_layouts__org_patternfly_showcase_Data = /**@type {Object<string, Object>}*/ (Js.m_cast__java_lang_Object__java_lang_Object(goog.global.JSON.parse(ShowcaseBundleImpl.f_INSTANCE__org_patternfly_showcase_ShowcaseBundleImpl.m_layouts__org_treblereel_j2cl_processors_common_resources_TextResource().m_getText__java_lang_String())));
 }
