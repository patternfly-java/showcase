goog.module('org.patternfly.showcase.GetStartedPage$impl');
...
class GetStartedPage extends j_l_Object {
 ...
 static $clinit() {
  GetStartedPage.$clinit = () =>{};
  GetStartedPage.$loadModules();
  j_l_Object.$clinit();
  Page.$clinit();
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof GetStartedPage;
 }
...
Page.$markImplementor(GetStartedPage);
$Util.$setClassMetadata(GetStartedPage, 'org.patternfly.showcase.GetStartedPage');

exports = GetStartedPage;

//# sourceMappingURL=GetStartedPage.js.map
