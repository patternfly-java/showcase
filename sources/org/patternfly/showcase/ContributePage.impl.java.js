goog.module('org.patternfly.showcase.ContributePage$impl');
 ...
 * @implements {Page}
 */
class ContributePage extends j_l_Object {
 /** @protected @nodts */
 constructor() {
  super();
 }
 /** @nodts @return {!ContributePage} */
 static $create__() {
  ContributePage.$clinit();
  let $instance = new ContributePage();
  $instance.$ctor__org_patternfly_showcase_ContributePage__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_showcase_ContributePage__void() {
 ...
 static $clinit() {
  ContributePage.$clinit = () =>{};
  ContributePage.$loadModules();
  j_l_Object.$clinit();
  Page.$clinit();
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ContributePage;
 }
...
Page.$markImplementor(ContributePage);
$Util.$setClassMetadata(ContributePage, 'org.patternfly.showcase.ContributePage');

exports = ContributePage;
