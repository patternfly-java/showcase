...
class NotYetImplemented extends j_l_Object {
 ...
 $ctor__org_patternfly_showcase_component_NotYetImplemented__void() {
  ...
  this.f_root__org_patternfly_showcase_component_NotYetImplemented_ = /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {Alert}*/ ($Casts.$to(/**@type {Alert}*/ ($Casts.$to(Alert.m_alert__org_patternfly_core_Severity__java_lang_String__org_patternfly_component_alert_Alert(Severity.f_warning__org_patternfly_core_Severity, 'Not yet implemented').m_inline__org_jboss_elemento_TypedBuilder(), Alert)).m_plain__org_jboss_elemento_TypedBuilder(), Alert)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
 }
 ...
 static $loadModules() {
  ...
  Severity = goog.module.get('org.patternfly.core.Severity$impl');
