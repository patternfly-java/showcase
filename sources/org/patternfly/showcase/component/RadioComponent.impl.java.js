...
class RadioComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_RadioComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-reversed', 'Reversed', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-reversed'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-disabled', 'Disabled', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-disabled'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-description', 'Radio with description', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-description'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-body', 'Radio with body', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-body'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-description-body', 'Radio with description and body', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-description-body'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('radio-standalone', 'Standalone input', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('radio-standalone'), j_l_String)), Supplier.$adapt(() =>{
