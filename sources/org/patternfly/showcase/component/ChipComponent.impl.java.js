...
class ChipComponent extends ComponentPage {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_showcase_component_ChipComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('chip-variants', 'Chip variants', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('chip-variants'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('chip-group', 'Chip group', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('chip-group'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('chip-group-category', 'Chip group with category', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('chip-group-category'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('chip-group-removable-category', 'Chip group with removable category', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('chip-group-removable-category'), j_l_String)), Supplier.$adapt(() =>{
