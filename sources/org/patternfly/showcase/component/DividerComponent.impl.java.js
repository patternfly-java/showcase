...
class DividerComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_DividerComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-hr', 'Using hr', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-hr'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-li', 'Using li', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-li'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-div', 'Using div', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-div'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Divider.m_divider__org_patternfly_component_divider_DividerType__org_patternfly_component_divider_Divider(DividerType.f_div__org_patternfly_component_divider_DividerType)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-inset-md', 'Inset medium', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-inset-md'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-inset-breakpoints', 'Inset at various breakpoints', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-inset-breakpoints'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-orientation-vertical', 'Vertical in flex layout', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-orientation-vertical'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-orientation-vertical-inset-md', 'Vertical in flex layout, inset medium', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-orientation-vertical-inset-md'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-orientation-vertical-inset-breakpoints', 'Vertical in flex layout, inset at various breakpoints', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-orientation-vertical-inset-breakpoints'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('divider-orientation-switch', 'Switch orientation at various breakpoints', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('divider-orientation-switch'), j_l_String)), Supplier.$adapt(() =>{
