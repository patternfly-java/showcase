...
class TooltipComponent extends ComponentPage {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_showcase_component_TooltipComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tooltip-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tooltip-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tooltip-dynamic', 'Dynamic content', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tooltip-dynamic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tooltip-auto', 'Placement auto', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tooltip-auto'), j_l_String)), Supplier.$adapt(() =>{
