...
class FormSelectComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_FormSelectComponent__void() {
  this.$ctor__org_patternfly_showcase_SnippetPage__java_lang_String__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void('Form select', 'https://patternfly-java.github.io/patternfly-java/org/patternfly/component/form/FormSelect.html', 'https://www.patternfly.org/components/forms/form-select/design-guidelines', /**@type {HTMLParagraphElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to(Elements.m_p__org_jboss_elemento_HTMLContainerBuilder().m_textContent__java_lang_String__org_jboss_elemento_TypedBuilder('A form select embeds browser native select lists into a form.'), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('form-select-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-validated', 'Validated', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('form-select-validated'), j_l_String)), Supplier.$adapt(() =>{
   ...
   let formSelect = FormSelect.m_formSelect__java_lang_String__org_patternfly_component_form_FormSelect('validated-form-select-0').m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_FormSelect(ChangeHandler.$adapt((/** Event */ e, fs, value) =>{
    ...
    fs_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_default___org_patternfly_core_ValidationStatus);
    ...
    $Arrays.$set(handle, 0, DomGlobal_$Overlay.m_setTimeout__elemental2_dom_DomGlobal_SetTimeoutCallbackFn__double__arrayOf_java_lang_Object__double((.../** ...* */ __) =>{
     if (number_1 == 0) {
      fs_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_warning__org_patternfly_core_ValidationStatus);
      ...
      fs_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_success__org_patternfly_core_ValidationStatus);
      ...
      fs_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_error__org_patternfly_core_ValidationStatus);
      helperText.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_error__org_patternfly_core_ValidationStatus).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem('You must chose Three (thought that was obvious)');
     }
    }, 1234, []));
   }));
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-disabled', 'Disabled', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('form-select-disabled'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('form-select-grouped', 'Grouped', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('form-select-grouped'), j_l_String)), Supplier.$adapt(() =>{
