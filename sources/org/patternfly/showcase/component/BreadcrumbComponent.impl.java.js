...
class BreadcrumbComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_BreadcrumbComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('breadcrumb-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('breadcrumb-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('breadcrumb-no-home-link', 'Without home link', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('breadcrumb-no-home-link'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('breadcrumb-heading', 'With heading', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('breadcrumb-heading'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('breadcrumb-dropdown', 'With dropdown', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('breadcrumb-dropdown'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(NotYetImplemented.m_nyi__org_patternfly_showcase_component_NotYetImplemented()), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
