...
class TextInputGroupComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TextInputGroupComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tig-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tig-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tig-disabled', 'Disabled', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tig-disabled'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tig-utilities-and-icon', 'Utilities and icon', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tig-utilities-and-icon'), j_l_String)), Supplier.$adapt(() =>{
   let textInputGroup = TextInputGroup.m_textInputGroup__org_patternfly_component_textinputgroup_TextInputGroup();
   textInputGroup.m_addMain__org_patternfly_component_textinputgroup_TextInputGroupMain__org_patternfly_component_textinputgroup_TextInputGroup(/**@type {TextInputGroupMain}*/ ($Casts.$to(TextInputGroupMain.m_textInputGroupMain__java_lang_String__org_patternfly_component_textinputgroup_TextInputGroupMain('tig-utilities-and-icon-0').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_search__org_patternfly_style_PredefinedIcon), TextInputGroupMain)).m_placeholder__java_lang_String__org_patternfly_component_textinputgroup_TextInputGroupMain('Placeholder').m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_textinputgroup_TextInputGroupMain(ChangeHandler.$adapt((/** Event */ e, tig, value) =>{
   ...
   }))).m_addUtilities__org_patternfly_component_textinputgroup_TextInputGroupUtilities__org_patternfly_component_textinputgroup_TextInputGroup(/**@type {TextInputGroupUtilities}*/ ($Casts.$to(TextInputGroupUtilities.m_textInputGroupUtilities__org_patternfly_component_textinputgroup_TextInputGroupUtilities().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_times__org_patternfly_style_PredefinedIcon), Button)).m_plain__org_jboss_elemento_TypedBuilder(), Button)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (e_1) =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('tig-filters', 'Filters', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('tig-filters'), j_l_String)), Supplier.$adapt(() =>{
   ...
   }))).m_addUtilities__org_patternfly_component_textinputgroup_TextInputGroupUtilities__org_patternfly_component_textinputgroup_TextInputGroup(/**@type {TextInputGroupUtilities}*/ ($Casts.$to(TextInputGroupUtilities.m_textInputGroupUtilities__boolean__org_patternfly_component_textinputgroup_TextInputGroupUtilities(false).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_times__org_patternfly_style_PredefinedIcon), Button)).m_plain__org_jboss_elemento_TypedBuilder(), Button)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (e_4) =>{
   ...
   chipsPresent.m_subscribe__org_patternfly_core_ObservableValue_Subscriber__org_patternfly_core_ObservableValue(Subscriber.$adapt((current, previous) =>{
    ...
    if (Boolean.m_booleanValue__java_lang_Boolean__boolean(current_1)) {
     ...
     textInputGroup_1.m_main__org_patternfly_component_textinputgroup_TextInputGroupMain().m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_search__org_patternfly_style_PredefinedIcon);
