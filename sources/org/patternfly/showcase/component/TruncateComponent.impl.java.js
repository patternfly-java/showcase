...
class TruncateComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TruncateComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-default', 'Default', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('truncate-default'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-middle', 'Middle', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('truncate-middle'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('truncate-start', 'Start', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('truncate-start'), j_l_String)), Supplier.$adapt(() =>{
