...
class JumpLinksComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_JumpLinksComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-center', 'With centered list', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-center'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-label', 'With label', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-label'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-vertical', 'Vertical', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-vertical'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-vertical-label', 'Vertical with label', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-vertical-label'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('jump-links-expandable', 'Expandable vertical with subsection', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('jump-links-expandable'), j_l_String)), Supplier.$adapt(() =>{
