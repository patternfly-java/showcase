...
class ExpandableSectionComponent extends ComponentPage {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_showcase_component_ExpandableSectionComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-dynamic-text', 'Basic with dynamic toggle text', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-dynamic-text'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-detached', 'Detached', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-detached'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Stack.m_stack__org_patternfly_layout_stack_Stack().m_gutter__org_patternfly_layout_stack_Stack().m_addItem__org_patternfly_layout_stack_StackItem__org_patternfly_layout_stack_Stack(/**@type {StackItem}*/ ($Casts.$to(StackItem.m_stackItem__org_patternfly_layout_stack_StackItem().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ExpandableSection.m_expandableSection__java_lang_String__org_patternfly_component_expandable_ExpandableSection('detached-content').m_detachedFrom__java_lang_String__org_patternfly_component_expandable_ExpandableSection('detached-toggle').m_addContent__org_patternfly_component_expandable_ExpandableSectionContent__org_patternfly_component_expandable_ExpandableSection(/**@type {ExpandableSectionContent}*/ ($Casts.$to(ExpandableSectionContent.m_expandableSectionContent__org_patternfly_component_expandable_ExpandableSectionContent().m_textContent__java_lang_String__org_jboss_elemento_TypedBuilder('This content is visible only when the component is expanded.'), ExpandableSectionContent)))), StackItem))).m_addItem__org_patternfly_layout_stack_StackItem__org_patternfly_layout_stack_Stack(/**@type {StackItem}*/ ($Casts.$to(StackItem.m_stackItem__org_patternfly_layout_stack_StackItem().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ExpandableSection.m_expandableSection__java_lang_String__org_patternfly_component_expandable_ExpandableSection('detached-toggle').m_detachedFrom__java_lang_String__org_patternfly_component_expandable_ExpandableSection('detached-content').m_addToggle__org_patternfly_component_expandable_ExpandableSectionToggle__org_patternfly_component_expandable_ExpandableSection(ExpandableSectionToggle.m_expandableSectionToggle__java_lang_String__java_lang_String__org_patternfly_component_expandable_ExpandableSectionToggle('Show more', 'Show less').m_up__org_patternfly_component_expandable_ExpandableSectionToggle())), StackItem)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-disclosure', 'Disclosure variation', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-disclosure'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ExpandableSection.m_expandableSection__org_patternfly_component_expandable_ExpandableSection().m_disclosure__org_patternfly_component_expandable_ExpandableSection().m_addToggle__org_patternfly_component_expandable_ExpandableSectionToggle__org_patternfly_component_expandable_ExpandableSection(ExpandableSectionToggle.m_expandableSectionToggle__java_lang_String__java_lang_String__org_patternfly_component_expandable_ExpandableSectionToggle('Show more', 'Show less')).m_addContent__org_patternfly_component_expandable_ExpandableSectionContent__org_patternfly_component_expandable_ExpandableSection(/**@type {ExpandableSectionContent}*/ ($Casts.$to(ExpandableSectionContent.m_expandableSectionContent__org_patternfly_component_expandable_ExpandableSectionContent().m_textContent__java_lang_String__org_jboss_elemento_TypedBuilder('This content is visible only when the component is expanded.'), ExpandableSectionContent)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-indented', 'Indented', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-indented'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ExpandableSection.m_expandableSection__org_patternfly_component_expandable_ExpandableSection().m_indented__org_patternfly_component_expandable_ExpandableSection().m_addToggle__org_patternfly_component_expandable_ExpandableSectionToggle__org_patternfly_component_expandable_ExpandableSection(ExpandableSectionToggle.m_expandableSectionToggle__java_lang_String__java_lang_String__org_patternfly_component_expandable_ExpandableSectionToggle('Show more', 'Show less')).m_addContent__org_patternfly_component_expandable_ExpandableSectionContent__org_patternfly_component_expandable_ExpandableSection(/**@type {ExpandableSectionContent}*/ ($Casts.$to(ExpandableSectionContent.m_expandableSectionContent__org_patternfly_component_expandable_ExpandableSectionContent().m_textContent__java_lang_String__org_jboss_elemento_TypedBuilder('This content is visible only when the component is expanded.'), ExpandableSectionContent)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-custom-toggle', 'With custom toggle content', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-custom-toggle'), j_l_String)), Supplier.$adapt(() =>{
   let badge = Badge.m_badge__int__org_patternfly_component_badge_Badge(4).m_read__org_patternfly_component_badge_Badge();
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ExpandableSection.m_expandableSection__org_patternfly_component_expandable_ExpandableSection().m_onToggle__org_patternfly_handler_ToggleHandler__org_patternfly_component_expandable_ExpandableSection(ToggleHandler.$adapt((component, /** boolean */ expanded) =>{
    let component_1 = /**@type {ExpandableSection}*/ ($Casts.$to(component, ExpandableSection));
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('expandable-section-truncate', 'Truncate', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('expandable-section-truncate'), j_l_String)), Supplier.$adapt(() =>{
