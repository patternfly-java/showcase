...
class SpinnerComponent extends ComponentPage {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 $ctor__org_patternfly_showcase_component_SpinnerComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('spinner-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_component_Snippet__void_$pp_org_patternfly_showcase_component(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('spinner-inline-size', 'Inline size', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('spinner-inline-size'), j_l_String)), Supplier.$adapt(() =>{
