...
class MastheadComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_MastheadComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-mixed-content', 'Basic with mixed content', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-mixed-content'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-inline', 'Display inline', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-inline'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-stack', 'Display stack', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-stack'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-responsive', 'Display stack, display inline responsive', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-responsive'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-light', 'Light variant', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-light'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-light-200', 'Light 200 variant', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-light-200'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-inset', 'Inset', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-inset'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('masthead-router', 'With icon router link', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('masthead-router'), j_l_String)), Supplier.$adapt(() =>{
