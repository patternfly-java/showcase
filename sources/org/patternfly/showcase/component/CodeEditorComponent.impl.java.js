...
class CodeEditorComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_CodeEditorComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-editor-readonly', 'Readonly', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('code-editor-readonly'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {CodeEditor}*/ ($Casts.$to(CodeEditor.m_codeEditor__org_patternfly_component_code_CodeEditor().m_readonly__org_jboss_elemento_TypedBuilder(), CodeEditor)).m_addHeader__org_patternfly_component_code_CodeEditorHeader__org_patternfly_component_code_CodeEditor(CodeEditorHeader.m_codeEditorHeader__org_patternfly_component_code_CodeEditorHeader().m_addActions__org_patternfly_component_code_CodeEditorActions__org_patternfly_component_code_CodeEditorHeader(CodeEditorActions.m_codeEditorActions__org_patternfly_component_code_CodeEditorActions().m_addAction__org_patternfly_component_code_CodeEditorAction__org_patternfly_component_code_CodeEditorActions(CodeEditorAction.m_codeEditorCopyToClipboardAction__org_patternfly_component_code_CodeEditorAction()).m_addAction__org_patternfly_component_code_CodeEditorAction__org_patternfly_component_code_CodeEditorActions(CodeEditorAction.m_codeEditorAction__org_patternfly_style_PredefinedIcon__org_patternfly_component_code_CodeEditorAction(PredefinedIcon.f_download__org_patternfly_style_PredefinedIcon)).m_addAction__org_patternfly_component_code_CodeEditorAction__org_patternfly_component_code_CodeEditorActions(CodeEditorAction.m_codeEditorAction__org_patternfly_component_button_Button__org_patternfly_component_code_CodeEditorAction(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_upload__org_patternfly_style_PredefinedIcon), Button)).m_control__org_patternfly_component_button_Button().m_disabled__org_jboss_elemento_TypedBuilder(), Button))))).m_addTab__org_patternfly_component_code_CodeEditorTab__org_patternfly_component_code_CodeEditorHeader(CodeEditorTab.m_codeEditorTab__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_component_code_CodeEditorTab(PredefinedIcon.f_code__org_patternfly_style_PredefinedIcon, 'Java'))).m_code__java_lang_String__org_patternfly_component_code_CodeEditor(CodeEditorComponent.f_CODE__org_patternfly_showcase_component_CodeEditorComponent_)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-editor-no-actions', 'Without actions', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('code-editor-no-actions'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-editor-no-tab', 'Without tab', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('code-editor-no-tab'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('code-editor-no-actions-no-tab', 'Without actions and tab', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('code-editor-no-actions-no-tab'), j_l_String)), Supplier.$adapt(() =>{
