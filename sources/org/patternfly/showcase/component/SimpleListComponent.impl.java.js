...
class SimpleListComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_SimpleListComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('simple-list', 'Simple list', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('simple-list'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('grouped-list', 'Grouped list', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('grouped-list'), j_l_String)), Supplier.$adapt(() =>{
