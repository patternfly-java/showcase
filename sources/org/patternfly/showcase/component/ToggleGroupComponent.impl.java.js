...
class ToggleGroupComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_ToggleGroupComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('toggle-group-multiple', 'Default with multiple selectable', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('toggle-group-multiple'), j_l_String)), Supplier.$adapt(() =>{
   ...
   let toggleGroup = ToggleGroup.m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(SelectionMode.f_multi__org_patternfly_core_SelectionMode);
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('toggle-group-single', 'Default with single selectable', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('toggle-group-single'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ToggleGroup.m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(SelectionMode.f_single__org_patternfly_core_SelectionMode).m_addItems__java_lang_Iterable__java_util_function_Function__org_patternfly_component_togglegroup_ToggleGroup(/**@type {List<Integer>}*/ ($Casts.$to(IntStream.m_range__int__int__java_util_stream_IntStream(1, 4).m_boxed__java_util_stream_Stream().m_collect__java_util_stream_Collector__java_lang_Object(/**@type {Collector<Integer, *, List<Integer>>}*/ (Collectors.m_toList__java_util_stream_Collector())), List)), j_u_function_Function.$adapt((index) =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('toggle-group-icon', 'With icon', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('toggle-group-icon'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ToggleGroup.m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(SelectionMode.f_multi__org_patternfly_core_SelectionMode).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-icon-0').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_copy__org_patternfly_style_PredefinedIcon), ToggleGroupItem))).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-icon-1').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_undo__org_patternfly_style_PredefinedIcon), ToggleGroupItem))).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-icon-2').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_shareSquare__org_patternfly_style_PredefinedIcon), ToggleGroupItem)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('toggle-group-text-icon', 'With icon', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('toggle-group-text-icon'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(ToggleGroup.m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(SelectionMode.f_multi__org_patternfly_core_SelectionMode).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-text-icon-0', 'Copy').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_copy__org_patternfly_style_PredefinedIcon), ToggleGroupItem))).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-text-icon-1', 'Undo').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_undo__org_patternfly_style_PredefinedIcon), ToggleGroupItem))).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-text-icon-2', 'Share').m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(PredefinedIcon.f_shareSquare__org_patternfly_style_PredefinedIcon), ToggleGroupItem)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('toggle-group-compact', 'Compact variant', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('toggle-group-compact'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {ToggleGroup}*/ ($Casts.$to(ToggleGroup.m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(SelectionMode.f_multi__org_patternfly_core_SelectionMode).m_compact__org_jboss_elemento_TypedBuilder(), ToggleGroup)).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-compact-0', 'Option 1')).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-compact-1', 'Option 2')).m_addItem__org_patternfly_component_togglegroup_ToggleGroupItem__org_patternfly_component_togglegroup_ToggleGroup(/**@type {ToggleGroupItem}*/ ($Casts.$to(ToggleGroupItem.m_toggleGroupItem__java_lang_String__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem('toggle-group-compact-2', 'Option 3').m_disabled__org_jboss_elemento_TypedBuilder(), ToggleGroupItem)))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
