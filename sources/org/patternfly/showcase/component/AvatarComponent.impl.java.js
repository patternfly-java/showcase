...
class AvatarComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_AvatarComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('avatar-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('avatar-basic'), j_l_String)), Supplier.$adapt(() =>{
