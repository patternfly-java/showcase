...
class ProgressComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_ProgressComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-small', 'Small', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-small'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-large', 'Large', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-large'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outside', 'Outside', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-outside'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-inside', 'Inside', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-inside'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-success', 'Success', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-success'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-failure', 'Failure', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-failure'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(Status.f_danger__org_patternfly_style_Status).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-warning', 'Warning', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-warning'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-inside-success', 'Inside success', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-inside-success'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outside-failure', 'Outside failure', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-outside-failure'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-single-line', 'Single line', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-single-line'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-no-measure', 'Without measure', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-no-measure'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_none__org_patternfly_component_progress_MeasureLocation).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-no-measure-failure', 'Failure without measure', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-no-measure-failure'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(Progress.m_progress__org_patternfly_component_progress_Progress().m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(Status.f_danger__org_patternfly_style_Status).m_measureLocation__org_patternfly_component_progress_MeasureLocation__org_patternfly_component_progress_Progress(MeasureLocation.f_none__org_patternfly_component_progress_MeasureLocation).m_title__java_lang_String__org_patternfly_component_progress_Progress('Title').m_value__int__org_patternfly_component_progress_Progress(33)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-finite-step', 'Finite step', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-finite-step'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-truncate', 'Truncate', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-truncate'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-outer-title', 'Title outside of progress bar', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-outer-title'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('progress-helper-text', 'Helper text', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('progress-helper-text'), j_l_String)), Supplier.$adapt(() =>{
