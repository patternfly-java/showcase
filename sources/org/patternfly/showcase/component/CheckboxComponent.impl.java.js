...
class CheckboxComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_CheckboxComponent__void() {
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-disabled', 'Disabled', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-disabled'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-description', 'Checkbox with description', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-description'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-body', 'Checkbox with body', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-body'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-standalone', 'Standalone input', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-standalone'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('checkbox-required', 'Required input', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('checkbox-required'), j_l_String)), Supplier.$adapt(() =>{
