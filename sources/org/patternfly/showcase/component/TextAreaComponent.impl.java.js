...
class TextAreaComponent extends SnippetPage {
 ...
 $ctor__org_patternfly_showcase_component_TextAreaComponent__void() {
  this.$ctor__org_patternfly_showcase_SnippetPage__java_lang_String__java_lang_String__java_lang_String__elemental2_dom_HTMLElement__void('Text area', 'https://patternfly-java.github.io/patternfly-java/org/patternfly/component/form/TextArea.html', 'https://www.patternfly.org/components/forms/text-area/design-guidelines', /**@type {HTMLParagraphElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLParagraphElement>}*/ ($Casts.$to(Elements.m_p__org_jboss_elemento_HTMLContainerBuilder().m_textContent__java_lang_String__org_jboss_elemento_TypedBuilder('A text area component is used for entering a paragraph of text that is longer than one line.'), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), $Overlay)));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-basic', 'Basic', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-basic'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-invalid', 'Invalid', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-invalid'), j_l_String)), Supplier.$adapt(() =>{
   return /**@type {HTMLDivElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {TextArea}*/ ($Casts.$to(TextArea.m_textArea__java_lang_String__org_patternfly_component_form_TextArea('invalid-text-area-0').m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_error__org_patternfly_core_ValidationStatus), TextArea))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay));
  })));
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-validated', 'Validated', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-validated'), j_l_String)), Supplier.$adapt(() =>{
   ...
   let textArea = TextArea.m_textArea__java_lang_String__org_patternfly_component_form_TextArea('validated-text-area-0').m_onChange__org_patternfly_handler_ChangeHandler__org_patternfly_component_form_TextArea(ChangeHandler.$adapt((/** Event */ e, ta, value) =>{
    ...
    ta_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_default___org_patternfly_core_ValidationStatus);
    helperText.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_default___org_patternfly_core_ValidationStatus).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem('Validating...');
    $Arrays.$set(handle, 0, DomGlobal_$Overlay.m_setTimeout__elemental2_dom_DomGlobal_SetTimeoutCallbackFn__double__arrayOf_java_lang_Object__double((.../** ...* */ __) =>{
     if (j_l_String.m_isEmpty__java_lang_String__boolean(value_1)) {
      ta_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_warning__org_patternfly_core_ValidationStatus);
      helperText.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_warning__org_patternfly_core_ValidationStatus).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem('You must have something to say');
     } else {
      if (j_l_String.m_length__java_lang_String__int(value_1) < 10) {
       ta_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_error__org_patternfly_core_ValidationStatus);
       helperText.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_error__org_patternfly_core_ValidationStatus).m_text__java_lang_String__org_patternfly_component_help_HelperTextItem('You\'re being too brief, please enter at least 10 characters.');
      } else {
       ta_1.m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(ValidationStatus.f_success__org_patternfly_core_ValidationStatus);
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-vertical', 'Vertically resizable', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-vertical'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-horizontal', 'Horizontally resizable', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-horizontal'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-both', 'Vertically and horizontally resizable', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-both'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-disabled', 'Disabled', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-disabled'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-area-readonly', 'Read only', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-area-readonly'), j_l_String)), Supplier.$adapt(() =>{
  ...
  this.m_addSnippet__org_patternfly_showcase_Snippet__void(Snippet.$create__java_lang_String__java_lang_String__java_lang_String__java_util_function_Supplier('text-auto-size', 'Auto resizing', /**@type {?string}*/ ($Casts.$to(PatternFlyCode.code.get('text-auto-size'), j_l_String)), Supplier.$adapt(() =>{
