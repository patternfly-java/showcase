...
let Main = goog.forwardDeclare('org.patternfly.showcase.Main$impl');
...
class SnippetPage extends j_l_Object {
 ...
 static $loadModules() {
  ...
  Main = goog.module.get('org.patternfly.showcase.Main$impl');
