goog.module('org.patternfly.thirdparty.popper.Modifiers$impl');
...
class Modifiers {
 ...
 static m_placement__org_patternfly_thirdparty_popper_Modifier() {
  ...
  modifier.enabled = true;
  modifier.phase = ModifierPhase.f_main__org_patternfly_thirdparty_popper_ModifierPhase.name();
  modifier.fn = (/** Object */ args) =>{
   if (!$Equality.$same(args.state, null) && !$Equality.$same(args.state.elements, null)) {
    let placement = Placement.m_fromValue__java_lang_String__org_patternfly_thirdparty_popper_Placement(args.state.placement);
    let popper = args.state.elements.popper;
    if (!$Equality.$same(placement, null) && !$Equality.$same(popper, null)) {
     popper.classList.remove(...InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(Placement.f_modifiers__org_patternfly_thirdparty_popper_Placement));
     popper.classList.add(placement.f_modifier__org_patternfly_thirdparty_popper_Placement);
    }
   }
  };
  return modifier;
 ...
 /** @nodts @return {Object} */
 static m_offset__int__org_patternfly_thirdparty_popper_Modifier(/** number */ offset) {
  Modifiers.$clinit();
  let modifier = new Object();
 ...
 /** @nodts @return {Object} */
 static m_noOverflow__org_patternfly_thirdparty_popper_Modifier() {
  Modifiers.$clinit();
  let modifier = new Object();
 ...
 /** @nodts @return {Object} */
 static m_hide__org_patternfly_thirdparty_popper_Modifier() {
  Modifiers.$clinit();
  let modifier = new Object();
  modifier.name = 'hide';
  modifier.enabled = true;
 ...
 /** @nodts @return {Object} */
 static m_flip__boolean__org_patternfly_thirdparty_popper_Modifier(/** boolean */ enabled) {
  Modifiers.$clinit();
  let modifier = new Object();
  modifier.name = 'flip';
 ...
 /** @nodts @return {Object} */
 static m_eventListeners__boolean__org_patternfly_thirdparty_popper_Modifier(/** boolean */ enabled) {
  Modifiers.$clinit();
  let modifier = new Object();
 ...
 static $markImplementor(/** Function */ ctor) {
  ctor.prototype.$implements__org_patternfly_thirdparty_popper_Modifiers = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_thirdparty_popper_Modifiers;
 }
...
$Util.$setClassMetadataForInterface(Modifiers, 'org.patternfly.thirdparty.popper.Modifiers');
