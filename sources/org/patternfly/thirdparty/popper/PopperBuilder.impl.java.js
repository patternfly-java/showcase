goog.module('org.patternfly.thirdparty.popper.PopperBuilder$impl');
...
class PopperBuilder extends j_l_Object {
 ...
 constructor() {
  ...
  /**@type {HTMLElement} @nodts*/
  this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_;
  /**@type {Array<Object>} @nodts*/
  this.f_modifiers__org_patternfly_thirdparty_popper_PopperBuilder_;
  /**@type {List<HandlerRegistration>} @nodts*/
  this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_;
  /**@type {number} @nodts*/
  this.f_animationDuration__org_patternfly_thirdparty_popper_PopperBuilder_ = 0;
  /**@type {number} @nodts*/
  this.f_entryDelay__org_patternfly_thirdparty_popper_PopperBuilder_ = 0;
  /**@type {number} @nodts*/
  this.f_exitDelay__org_patternfly_thirdparty_popper_PopperBuilder_ = 0;
  /**@type {number} @nodts*/
  this.f_zIndex__org_patternfly_thirdparty_popper_PopperBuilder_ = 0;
 ...
 /** @nodts @return {PopperBuilder} */
 m_entryDelay__int__org_patternfly_thirdparty_popper_PopperBuilder(/** number */ entryDelay) {
  this.f_entryDelay__org_patternfly_thirdparty_popper_PopperBuilder_ = entryDelay;
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 m_exitDelay__int__org_patternfly_thirdparty_popper_PopperBuilder(/** number */ exitDelay) {
  this.f_exitDelay__org_patternfly_thirdparty_popper_PopperBuilder_ = exitDelay;
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 ...
 /** @nodts @return {PopperBuilder} */
 m_placement__org_patternfly_thirdparty_popper_Placement__org_patternfly_thirdparty_popper_PopperBuilder(/** Placement */ placement) {
  this.f_placement__org_patternfly_thirdparty_popper_PopperBuilder_ = placement;
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 m_addModifier__arrayOf_org_patternfly_thirdparty_popper_Modifier__org_patternfly_thirdparty_popper_PopperBuilder(/** Array<Object> */ modifiers) {
  this.f_modifiers__org_patternfly_thirdparty_popper_PopperBuilder_.push(...InternalPreconditions.m_checkNotNull__java_lang_Object__java_lang_Object(modifiers));
  return this;
 }
 /** @nodts @return {PopperBuilder} */
 m_registerHandler__java_util_Set__java_util_function_Consumer__java_util_function_Consumer__org_patternfly_thirdparty_popper_PopperBuilder(/** Set<TriggerAction> */ triggerActions, /** Consumer<Event> */ show, /** Consumer<Event> */ hide) {
  return this.m_registerHandler__elemental2_dom_HTMLElement__java_util_Set__java_util_function_Consumer__java_util_function_Consumer__org_patternfly_thirdparty_popper_PopperBuilder(this.f_triggerElement__org_patternfly_thirdparty_popper_PopperBuilder_, triggerActions, show, hide);
 }
 /** @nodts @return {PopperBuilder} */
 m_registerHandler__elemental2_dom_HTMLElement__java_util_Set__java_util_function_Consumer__java_util_function_Consumer__org_patternfly_thirdparty_popper_PopperBuilder(/** HTMLElement */ triggerElement, /** Set<TriggerAction> */ triggerActions, /** Consumer<Event> */ show, /** Consumer<Event> */ hide) {
  if (triggerActions.contains(TriggerAction.f_mouseenter__org_patternfly_thirdparty_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(triggerElement, EventType.f_mouseenter__org_jboss_elemento_EventType, (e) =>{
   ...
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_, EventType.f_mouseenter__org_jboss_elemento_EventType, (e_4) =>{
    let e_5 = /**@type {MouseEvent}*/ ($Casts.$to(e_4, MouseEvent_$Overlay));
    show.m_accept__java_lang_Object__void(e_5);
   }));
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_, EventType.f_mouseleave__org_jboss_elemento_EventType, (e_6) =>{
    let e_7 = /**@type {MouseEvent}*/ ($Casts.$to(e_6, MouseEvent_$Overlay));
    hide.m_accept__java_lang_Object__void(e_7);
   }));
  }
  if (triggerActions.contains(TriggerAction.f_focus__org_patternfly_thirdparty_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(triggerElement, EventType.f_focus__org_jboss_elemento_EventType, (e_8) =>{
    let e_9 = /**@type {FocusEvent}*/ ($Casts.$to(e_8, FocusEvent_$Overlay));
    show.m_accept__java_lang_Object__void(e_9);
   }));
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(triggerElement, EventType.f_blur__org_jboss_elemento_EventType, (e_10) =>{
    let e_11 = /**@type {FocusEvent}*/ ($Casts.$to(e_10, FocusEvent_$Overlay));
    hide.m_accept__java_lang_Object__void(e_11);
   }));
  }
  if (triggerActions.contains(TriggerAction.f_click__org_patternfly_thirdparty_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_click__org_jboss_elemento_EventType, true, (e_12) =>{
    ...
    if (Elements.m_isVisible__elemental2_dom_HTMLElement__boolean(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_)) {
  ...
  if (!triggerActions.contains(TriggerAction.f_manual__org_patternfly_thirdparty_popper_TriggerAction)) {
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay, EventType.f_keydown__org_jboss_elemento_EventType, true, (e_14) =>{
    ...
    if (Elements.m_isVisible__elemental2_dom_HTMLElement__boolean(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_) && Key.f_Escape__org_jboss_elemento_Key.m_match__elemental2_dom_KeyboardEvent__boolean(e_15)) {
     hide.m_accept__java_lang_Object__void(e_15);
    }
   }));
   this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperBuilder_.add(EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_gwtproject_event_shared_HandlerRegistration(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_, EventType.f_keydown__org_jboss_elemento_EventType, (e_16) =>{
 ...
 /** @nodts @return {PopperBuilder} */
 m_removePopperOnTriggerDetach__org_patternfly_thirdparty_popper_PopperBuilder() {
  Elements.m_onDetach__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback__void(this.f_triggerElement__org_patternfly_thirdparty_popper_PopperBuilder_, ObserverCallback.$adapt((/** MutationRecord */ mr) =>{
   Elements.m_failSafeRemoveFromParent__elemental2_dom_Element__boolean(this.f_popperElement__org_patternfly_thirdparty_popper_PopperBuilder_);
  }));
  return this;
 }
...
$Util.$setClassMetadata(PopperBuilder, 'org.patternfly.thirdparty.popper.PopperBuilder');
