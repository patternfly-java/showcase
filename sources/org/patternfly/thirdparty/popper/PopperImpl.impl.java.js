goog.module('org.patternfly.thirdparty.popper.PopperImpl$impl');

const j_l_Object = goog.require('java.lang.Object$impl');
const $Util = goog.require('nativebootstrap.Util$impl');
const org_patternfly_thirdparty_popper_Popper = goog.require('org.patternfly.thirdparty.popper.Popper$impl');
...
/**
 * @implements {org_patternfly_thirdparty_popper_Popper}
 */
class PopperImpl extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {Popper} @nodts*/
  this.f_popper__org_patternfly_thirdparty_popper_PopperImpl_;
  /**@type {List<HandlerRegistration>} @nodts*/
  this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperImpl_;
  /**@type {number} @nodts*/
  this.f_animationDuration__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
  /**@type {number} @nodts*/
  this.f_entryDelay__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
  /**@type {number} @nodts*/
  this.f_exitDelay__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
  /**@type {number} @nodts*/
  this.f_transitionTimer__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
  /**@type {number} @nodts*/
  this.f_exitTimer__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
  /**@type {number} @nodts*/
  this.f_entryTimer__org_patternfly_thirdparty_popper_PopperImpl_ = 0;
 }
 /** @nodts @return {!PopperImpl} */
 static $create__org_patternfly_component_ComponentType__org_patternfly_thirdparty_popper_PopperJs__java_util_List__int__int__int(/** ComponentType */ componentType, /** Popper */ popper, /** List<HandlerRegistration> */ handlerRegistrations, /** number */ animationDuration, /** number */ entryDelay, /** number */ exitDelay) {
  PopperImpl.$clinit();
  let $instance = new PopperImpl();
  $instance.$ctor__org_patternfly_thirdparty_popper_PopperImpl__org_patternfly_component_ComponentType__org_patternfly_thirdparty_popper_PopperJs__java_util_List__int__int__int__void(componentType, popper, handlerRegistrations, animationDuration, entryDelay, exitDelay);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_thirdparty_popper_PopperImpl__org_patternfly_component_ComponentType__org_patternfly_thirdparty_popper_PopperJs__java_util_List__int__int__int__void(/** ComponentType */ componentType, /** Popper */ popper, /** List<HandlerRegistration> */ handlerRegistrations, /** number */ animationDuration, /** number */ entryDelay, /** number */ exitDelay) {
  this.$ctor__java_lang_Object__void();
  this.f_popper__org_patternfly_thirdparty_popper_PopperImpl_ = popper;
  this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperImpl_ = handlerRegistrations;
  this.f_animationDuration__org_patternfly_thirdparty_popper_PopperImpl_ = animationDuration;
  this.f_entryDelay__org_patternfly_thirdparty_popper_PopperImpl_ = entryDelay;
  this.f_exitDelay__org_patternfly_thirdparty_popper_PopperImpl_ = exitDelay;
 }
 ...
 /** @override @nodts */
 m_cleanup__void() {
  for (let $iterator = this.f_handlerRegistrations__org_patternfly_thirdparty_popper_PopperImpl_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
 ...
 m_internalShow__org_jboss_elemento_Callback__void_$p_org_patternfly_thirdparty_popper_PopperImpl(/** Callback */ visible) {
  ...
  this.f_popper__org_patternfly_thirdparty_popper_PopperImpl_.update().then((__) =>{
   ...
   if (this.f_animationDuration__org_patternfly_thirdparty_popper_PopperImpl_ != org_patternfly_thirdparty_popper_Popper.f_UNDEFINED__org_patternfly_thirdparty_popper_Popper) {
    this.f_popper__org_patternfly_thirdparty_popper_PopperImpl_.state.elements.popper.style.opacity = OpacityUnionType_$Overlay.m_of__java_lang_Object__elemental2_dom_CSSProperties_OpacityUnionType(Integer.m_valueOf__int__java_lang_Integer(1));
   }
 ...
 /** @nodts */
 m_toggleEvenListeners__boolean__void_$p_org_patternfly_thirdparty_popper_PopperImpl(/** boolean */ onOff) {
  this.f_popper__org_patternfly_thirdparty_popper_PopperImpl_.setOptions((/** Object */ existingOptions) =>{
...
org_patternfly_thirdparty_popper_Popper.$markImplementor(PopperImpl);
$Util.$setClassMetadata(PopperImpl, 'org.patternfly.thirdparty.popper.PopperImpl');
