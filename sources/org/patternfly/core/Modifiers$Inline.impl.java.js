...
class Inline {
 ...
 static m_inline__$default__org_patternfly_core_Modifiers_Inline__boolean__org_jboss_elemento_TypedBuilder(/** !Inline<E, B> */ $thisArg, /** boolean */ inline) {
  Inline.$clinit();
  return Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder($thisArg.m_that__org_jboss_elemento_TypedBuilder(), $thisArg.m_element__elemental2_dom_Element(), Classes.f_inline__org_patternfly_layout_Classes, inline);
 }
 /** @nodts */
 static $clinit() {
  Inline.$clinit = () =>{};
