...
class Tuples extends j_l_Object {
 ...
 static m_tuples__java_lang_Object__java_lang_Object__org_patternfly_core_Tuples(/** K_1 */ key1, /** V_1 */ value1) {
  Tuples.$clinit();
  ...
  return /**@type {!Tuples<K_1, V_1>}*/ (Tuples.$create__java_util_List(tuples));
 }
 /** @nodts @template K_1, V_1 @return {Tuples<K_1, V_1>} */
 ...
 static $create__java_util_List(/** List<Tuple<K, V>> */ tuples) {
  Tuples.$clinit();
  let $instance = new Tuples();
  $instance.$ctor__org_patternfly_core_Tuples__java_util_List__void(tuples);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_core_Tuples__java_util_List__void(/** List<Tuple<K, V>> */ tuples) {
  this.$ctor__java_lang_Object__void();
  this.f_tuples__org_patternfly_core_Tuples_ = tuples;
 }
