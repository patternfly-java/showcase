...
class Logger extends j_l_Object {
 ...
 /** @nodts */
 static m_debug__org_patternfly_component_ComponentType__java_lang_String__void(/** ComponentType */ componentType, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.debug(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, null, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_wrong__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.warn(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_missing__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.warn(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_nyi__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.error(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.error(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_unknown__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.error(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
 ...
 /** @nodts */
 static m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(/** ComponentType */ componentType, /** Element */ element, /** ?string */ message) {
  Logger.$clinit();
  goog.global.console.warn(Logger.m_format__java_lang_String__elemental2_dom_Element__java_lang_String__java_lang_String(componentType.f_componentName__org_patternfly_component_ComponentType, element, message));
 }
 /** @nodts */
