goog.module('org.patternfly.core.WithProgress$impl');
...
class WithProgress {
 ...
 static m_startProgress__$default__org_patternfly_core_WithProgress__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg) {
  WithProgress.$clinit();
 ...
 /** @nodts @template E, B @return {B} */
 static m_stopProgress__$default__org_patternfly_core_WithProgress__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg) {
  WithProgress.$clinit();
  if ($thisArg.m_inProgress__boolean()) {
 ...
 /** @nodts @template E, B @return {B} */
 static m_toggleProgress__$default__org_patternfly_core_WithProgress__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg) {
  WithProgress.$clinit();
  return $thisArg.m_progress__boolean__org_jboss_elemento_TypedBuilder(!$thisArg.m_inProgress__boolean());
 }
 /** @nodts @template E, B @return {B} */
 static m_progress__$default__org_patternfly_core_WithProgress__boolean__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg, /** boolean */ inProgress) {
  WithProgress.$clinit();
 ...
 /** @nodts @template E, B @return {B} */
 static m_progress__$default__org_patternfly_core_WithProgress__boolean__java_lang_String__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg, /** boolean */ inProgress, /** ?string */ label) {
  WithProgress.$clinit();
 ...
 /** @nodts @template E, B @return {B} */
 static m_progress__$default__org_patternfly_core_WithProgress__boolean__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(/** !WithProgress<E, B> */ $thisArg, /** boolean */ inProgress, /** Consumer<Spinner> */ spinnerConsumer) {
  WithProgress.$clinit();
 ...
 static $markImplementor(/** Function */ ctor) {
  ...
  ctor.prototype.$implements__org_patternfly_core_WithProgress = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_core_WithProgress;
 }
...
$Util.$setClassMetadataForInterface(WithProgress, 'org.patternfly.core.WithProgress');
