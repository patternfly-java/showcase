...
class Fill {
 ...
 static m_fill__$default__org_patternfly_core_Modifiers_Fill__boolean__org_jboss_elemento_TypedBuilder(/** !Fill<E, B> */ $thisArg, /** boolean */ fill) {
  Fill.$clinit();
  return Modifiers.m_changeModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder($thisArg.m_that__org_jboss_elemento_TypedBuilder(), $thisArg.m_element__elemental2_dom_Element(), Classes.f_fill__org_patternfly_layout_Classes, fill);
 }
 /** @nodts */
 static $clinit() {
  Fill.$clinit = () =>{};
