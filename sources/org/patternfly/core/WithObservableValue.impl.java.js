goog.module('org.patternfly.core.WithObservableValue$impl');
...
class WithObservableValue {
 ...
 static $markImplementor(/** Function */ ctor) {
  ...
  ctor.prototype.$implements__org_patternfly_core_WithObservableValue = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_core_WithObservableValue;
 }
...
$Util.$setClassMetadataForInterface(WithObservableValue, 'org.patternfly.core.WithObservableValue');
