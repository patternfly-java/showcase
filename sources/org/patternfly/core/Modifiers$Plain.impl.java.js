...
class Plain {
 ...
 static m_plain__$default__org_patternfly_core_Modifiers_Plain__boolean__org_jboss_elemento_TypedBuilder(/** !Plain<E, B> */ $thisArg, /** boolean */ plain) {
  Plain.$clinit();
  return Modifiers.m_changeModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder($thisArg.m_that__org_jboss_elemento_TypedBuilder(), $thisArg.m_element__elemental2_dom_Element(), Classes.f_plain__org_patternfly_layout_Classes, plain);
 }
 /** @nodts */
 static $clinit() {
  Plain.$clinit = () =>{};
