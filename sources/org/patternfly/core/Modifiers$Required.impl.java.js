...
class Required {
 ...
 static m_required__$default__org_patternfly_core_Modifiers_Required__boolean__org_jboss_elemento_TypedBuilder(/** !Required<E, B> */ $thisArg, /** boolean */ required) {
  Required.$clinit();
  return Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder($thisArg.m_that__org_jboss_elemento_TypedBuilder(), $thisArg.m_element__elemental2_dom_Element(), Classes.f_required__org_patternfly_layout_Classes, required);
 }
 /** @nodts */
 static $clinit() {
  Required.$clinit = () =>{};
