goog.module('org.patternfly.core.Modifiers.Readonly2$impl');
...
class Readonly2 {
 ...
 static m_readonly__$default__org_patternfly_core_Modifiers_Readonly2__org_jboss_elemento_TypedBuilder(/** !Readonly2<E, B> */ $thisArg) {
  Readonly2.$clinit();
  return $thisArg.m_readonly__boolean__org_jboss_elemento_TypedBuilder(true);
 }
 /** @nodts @template E, B @return {B} */
 static m_readonly__$default__org_patternfly_core_Modifiers_Readonly2__boolean__org_jboss_elemento_TypedBuilder(/** !Readonly2<E, B> */ $thisArg, /** boolean */ readonly) {
  Readonly2.$clinit();
 ...
 static $markImplementor(/** Function */ ctor) {
  ...
  ctor.prototype.$implements__org_patternfly_core_Modifiers_Readonly2 = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_core_Modifiers_Readonly2;
 }
...
$Util.$setClassMetadataForInterface(Readonly2, 'org.patternfly.core.Modifiers$Readonly2');
