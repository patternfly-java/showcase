goog.module('org.patternfly.core.Expandable$impl');
...
class Expandable {
 ...
 m_expanded__boolean() {}
 /** @nodts @template E, B */
 static m_toggle__$default__org_patternfly_core_Expandable__void(/** !Expandable<E, B> */ $thisArg) {
  Expandable.$clinit();
  $thisArg.m_toggle__boolean__void(true);
 }
 /** @nodts @template E, B */
 static m_toggle__$default__org_patternfly_core_Expandable__boolean__void(/** !Expandable<E, B> */ $thisArg, /** boolean */ fireEvent) {
  Expandable.$clinit();
 ...
 /** @nodts @template E, B */
 static m_collapse__$default__org_patternfly_core_Expandable__void(/** !Expandable<E, B> */ $thisArg) {
  Expandable.$clinit();
  $thisArg.m_collapse__boolean__void(true);
 }
 /** @nodts @template E, B */
 static m_expand__$default__org_patternfly_core_Expandable__void(/** !Expandable<E, B> */ $thisArg) {
  Expandable.$clinit();
  $thisArg.m_expand__boolean__void(true);
 }
 /** @nodts @template E, B @return {boolean} */
 static m_expanded__$default__org_patternfly_core_Expandable__boolean(/** !Expandable<E, B> */ $thisArg) {
  Expandable.$clinit();
 ...
 static $markImplementor(/** Function */ ctor) {
  ...
  ctor.prototype.$implements__org_patternfly_core_Expandable = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_core_Expandable;
 }
...
$Util.$setClassMetadataForInterface(Expandable, 'org.patternfly.core.Expandable');
