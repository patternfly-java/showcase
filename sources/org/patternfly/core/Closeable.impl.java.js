goog.module('org.patternfly.core.Closeable$impl');
...
class Closeable {
 ...
 /** @nodts @template E, B */
 static m_close__$default__org_patternfly_core_Closeable__void(/** !Closeable<E, B> */ $thisArg) {
  Closeable.$clinit();
  $thisArg.m_close__elemental2_dom_Event__boolean__void(new Event(''), true);
 }
 /** @nodts @template E, B */
 static m_close__$default__org_patternfly_core_Closeable__elemental2_dom_Event__void(/** !Closeable<E, B> */ $thisArg, /** Event */ event) {
  Closeable.$clinit();
 ...
 static $markImplementor(/** Function */ ctor) {
  ...
  ctor.prototype.$implements__org_patternfly_core_Closeable = true;
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance != null && !!instance.$implements__org_patternfly_core_Closeable;
 }
...
$Util.$setClassMetadataForInterface(Closeable, 'org.patternfly.core.Closeable');
