...
class GalleryItem extends BaseLayout {
 ...
 m_fill__org_jboss_elemento_TypedBuilder() {
  return /**@type {GalleryItem}*/ ($Casts.$to(Fill.m_fill__$default__org_patternfly_style_Modifiers_Fill__org_jboss_elemento_TypedBuilder(this), GalleryItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {GalleryItem} */
 m_fill__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {GalleryItem}*/ ($Casts.$to(Fill.m_fill__$default__org_patternfly_style_Modifiers_Fill__boolean__org_jboss_elemento_TypedBuilder(this, arg0), GalleryItem));
 }
