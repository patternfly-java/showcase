...
class BaseLayout extends j_l_Object {
 ...
 /** @nodts */
 $ctor__org_patternfly_layout_BaseLayout__elemental2_dom_HTMLElement__void(/** E */ element) {
  this.$ctor__java_lang_Object__void();
  this.f_element__org_patternfly_layout_BaseLayout_ = /**@type {E}*/ ($Casts.$to(Objects.m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(element, 'element required'), $Overlay));
 }
 /** @nodts @return {E} */
...
HasElement.$markImplementor(BaseLayout);
HasHTMLElement.$markImplementor(BaseLayout);
Finder.$markImplementor(BaseLayout);
Container.$markImplementor(BaseLayout);
