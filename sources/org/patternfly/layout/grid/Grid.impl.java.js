...
class Grid extends BaseLayout {
 ...
 m_columns__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_Grid(/** Breakpoints<Integer> */ columns) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp) =>{
   ...
   return Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/Grid', this.m_element__elemental2_dom_HTMLElement(), 'columns', /**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer)).m_intValue__int(), 1, 12);
 ...
 m_span__int__org_patternfly_layout_grid_Grid(/** number */ rows) {
  if (Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/Grid', this.m_element__elemental2_dom_HTMLElement(), 'span', rows, 1, 12)) {
