...
class GridItem extends BaseLayout {
 ...
 m_span__int__org_patternfly_layout_grid_GridItem(/** number */ columns) {
  if (Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'span', columns, 1, 12)) {
 ...
 m_span__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ columns) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp) =>{
   ...
   return Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'span', /**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer)).m_intValue__int(), 1, 12);
 ...
 m_rowSpan__int__org_patternfly_layout_grid_GridItem(/** number */ rows) {
  if (Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'rowSpan', rows, 1, 12)) {
 ...
 m_rowSpan__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ rows) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(rows.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp) =>{
   let bp_1 = /**@type {Tuple}*/ ($Casts.$to(bp, Tuple));
   return Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'rowSpan', /**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer)).m_intValue__int(), 1, 12);
  })).m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp_2) =>{
   let bp_3 = /**@type {Tuple}*/ ($Casts.$to(bp_2, Tuple));
   return !$Equality.$same(bp_3.f_key__org_patternfly_core_Tuple, Breakpoint.f_default___org_patternfly_style_Breakpoint);
 ...
 m_offset__int__org_patternfly_layout_grid_GridItem(/** number */ columns) {
  if (Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'offset', columns, 1, 12)) {
 ...
 m_offset__org_patternfly_style_Breakpoints__org_patternfly_layout_grid_GridItem(/** Breakpoints<Integer> */ columns) {
  let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp) =>{
   let bp_1 = /**@type {Tuple}*/ ($Casts.$to(bp, Tuple));
   return Validation.m_verifyRange__java_lang_String__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean('PF5/GridItem', this.m_element__elemental2_dom_HTMLElement(), 'offset', /**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer)).m_intValue__int(), 1, 12);
  })).m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp_2) =>{
   let bp_3 = /**@type {Tuple}*/ ($Casts.$to(bp_2, Tuple));
   return !$Equality.$same(bp_3.f_key__org_patternfly_core_Tuple, Breakpoint.f_default___org_patternfly_style_Breakpoint);
  })).m_collect__java_util_stream_Collector__java_lang_Object(/**@type {Collector<Tuple<Breakpoint, Integer>, StringBuilder, ?string>}*/ (BreakpointCollector.m_modifiers__java_util_function_Function__java_util_stream_Collector(j_u_function_Function.$adapt((col) =>{
