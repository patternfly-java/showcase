...
class Stack extends BaseLayout {
 ...
 m_gutter__org_patternfly_layout_stack_Stack() {
  return /**@type {Stack}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_gutter__org_patternfly_style_Classes)], j_l_String))), Stack));
 }
 /** @nodts @return {Stack} */
