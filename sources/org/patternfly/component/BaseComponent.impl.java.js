...
class BaseComponent extends j_l_Object {
 ...
 //Initialization from constructor 'BaseComponent(HTMLElement, String)'.
 /** @nodts */
 $ctor__org_patternfly_component_BaseComponent__elemental2_dom_HTMLElement__java_lang_String__void(/** E */ element, /** ?string */ component) {
  ...
  this.f_componentType__org_patternfly_component_BaseComponent_ = ComponentType.f_Unknown__org_patternfly_component_ComponentType;
 }
 //Initialization from constructor 'BaseComponent(HTMLElement, ComponentType)'.
 /** @nodts */
 $ctor__org_patternfly_component_BaseComponent__elemental2_dom_HTMLElement__org_patternfly_component_ComponentType__void(/** E */ element, /** ComponentType */ componentType) {
  this.$ctor__java_lang_Object__void();
  this.f_element__org_patternfly_component_BaseComponent_ = /**@type {E}*/ ($Casts.$to(Objects.m_requireNonNull__java_lang_Object__java_lang_String__java_lang_Object(element, 'element required'), $Overlay));
