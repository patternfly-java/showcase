...
class Avatar extends BaseComponentFlat {
 ...
 $ctor__org_patternfly_component_avatar_Avatar__java_lang_String__java_lang_String__void(/** ?string */ src, /** ?string */ alt) {
  this.$ctor__org_patternfly_component_BaseComponentFlat__elemental2_dom_HTMLElement__org_patternfly_component_ComponentType__void(/**@type {HTMLImageElement}*/ ($Casts.$to(/**@type {HTMLElementBuilder<HTMLImageElement>}*/ ($Casts.$to(/**@type {HTMLElementBuilder<HTMLImageElement>}*/ ($Casts.$to(Elements.m_img__org_jboss_elemento_HTMLElementBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_avatar__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([], j_l_String)))], j_l_String))), HTMLElementBuilder)).m_apply__java_util_function_Consumer__org_jboss_elemento_TypedBuilder(Consumer.$adapt((i) =>{
   let i_1 = /**@type {HTMLImageElement}*/ ($Casts.$to(i, $Overlay));
   i_1.src = src;
   i_1.alt = alt;
  })), HTMLElementBuilder)).m_element__elemental2_dom_HTMLElement(), $Overlay)), ComponentType.f_Avatar__org_patternfly_component_ComponentType);
 }
 /** @nodts @return {Avatar} */
 ...
 /** @nodts @return {Avatar} */
 m_size__org_patternfly_layout_Size__org_patternfly_component_avatar_Avatar(/** Size */ size) {
  return /**@type {Avatar}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([size.f_modifier__org_patternfly_layout_Size], j_l_String))), Avatar));
 }
 /** @nodts @return {Avatar} */
 m_border__org_patternfly_layout_Brightness__org_patternfly_component_avatar_Avatar(/** Brightness */ brightness) {
  return /**@type {Avatar}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([brightness.f_modifier__org_patternfly_layout_Brightness], j_l_String))), Avatar));
 }
 /** @nodts @return {Avatar} */
