...
class Avatar extends BaseComponentFlat {
 ...
 m_border__org_patternfly_style_Brightness__org_patternfly_component_avatar_Avatar(/** Brightness */ border) {
  if (Validation.m_verifyEnum__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__java_lang_String__java_lang_Enum__java_lang_Enum__arrayOf_java_lang_Enum__boolean(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {HTMLImageElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), $Overlay)), 'border', border, Brightness.f_light__org_patternfly_style_Brightness, /**@type {!Array<Brightness>}*/ ($Arrays.$init([Brightness.f_dark__org_patternfly_style_Brightness], Brightness)))) {
