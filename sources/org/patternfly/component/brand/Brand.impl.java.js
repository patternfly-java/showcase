...
class Brand extends BaseComponent {
 ...
 m_addSource__java_lang_String__java_lang_String__org_patternfly_component_brand_Brand(/** ?string */ src, /** ?string */ media) {
  if (this.f_picture__org_patternfly_component_brand_Brand_) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Adding sources is not supported for image based brands.\n' + 'Please create the brand w/o src and alt to add sources.');
  }
  return this;
 }
 /** @nodts @return {Brand} */
 ...
 m_add__org_jboss_elemento_HTMLElementBuilder__org_patternfly_component_brand_Brand(/** HTMLElementBuilder<HTMLImageElement> */ img) {
  if (this.f_picture__org_patternfly_component_brand_Brand_) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Adding a fallback image is not supported for image based brands.\n' + 'Please create the brand w/o src and alt to add a fallback image.');
  }
  return this;
 }
 /** @nodts @return {Brand} */
