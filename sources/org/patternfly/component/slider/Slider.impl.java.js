...
class Slider extends BaseComponentFlat {
 ...
 m_addValueInput__org_patternfly_component_form_TextInput__org_patternfly_component_slider_SliderInputPosition__org_patternfly_component_slider_Slider(/** TextInput */ textInput, /** SliderInputPosition */ inputPosition) {
  if ($Equality.$same(this.f_textInput__org_patternfly_component_slider_Slider_, null)) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Value input already added.');
  }
  return this;
 }
 /** @nodts @return {Slider} */
  ...
  if ($Equality.$same(this.f_inputGroup__org_patternfly_component_slider_Slider_, null)) {
   ...
   if (!$Equality.$same(inputGroupItem, null)) {
    if (TextInput.$isInstance(inputGroupItem.m_formControl__org_patternfly_component_form_FormControl())) {
     ...
     Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Value input does not contain a text input!');
    }
   } else {
    Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Value input does not contain a form control!');
   }
  } else {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Value input already added.');
  }
 ...
 m_addValueInputInternal__elemental2_dom_HTMLElement__org_patternfly_component_slider_SliderInputPosition__void_$p_org_patternfly_component_slider_Slider(/** HTMLElement */ element, /** SliderInputPosition */ inputPosition) {
  if ($Equality.$same(inputPosition, SliderInputPosition.f_aboveThumb__org_patternfly_component_slider_SliderInputPosition)) {
   ...
   if (!$Equality.$same(inputPosition, null)) {
    Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Unsupported input position: ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(inputPosition.name()));
   } else {
    Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'No input position!');
   }
  }
 }
 /** @nodts */
