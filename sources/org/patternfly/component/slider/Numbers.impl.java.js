goog.module('org.patternfly.component.slider.Numbers$impl');
...
class Numbers extends j_l_Object {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_patternfly_component_slider_Numbers__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_slider_Numbers__void() {
  this.$ctor__java_lang_Object__void();
 }
 /** @nodts @return {number} */
 static m_percentage__double__double__double(/** number */ value, /** number */ max) {
  Numbers.$clinit();
  return Numbers.m_round__double__double(value * 100 / max);
 }
 /** @nodts @return {number} */
 static m_percentage__double__double__double__double(/** number */ value, /** number */ min, /** number */ max) {
  Numbers.$clinit();
  return Numbers.m_round__double__double((value - min) * 100 / (max - min));
 }
 /** @nodts @return {number} */
...
$Util.$setClassMetadata(Numbers, 'org.patternfly.component.slider.Numbers');
