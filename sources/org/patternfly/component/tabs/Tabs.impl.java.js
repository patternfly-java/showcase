...
class Tabs extends BaseComponentFlat {
 ...
 $ctor__org_patternfly_component_tabs_Tabs__org_jboss_elemento_HTMLContainerBuilder__void(/** HTMLContainerBuilder<E> */ builder) {
  ...
  }), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(PredefinedIcon.f_angleRight__org_patternfly_style_PredefinedIcon)), HTMLContainerBuilder))), HTMLContainerBuilder));
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (this.f_vertical__org_patternfly_component_tabs_Tabs_) {
   if (this.f_overflowHorizontal__org_patternfly_component_tabs_Tabs_) {
    Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {Element}*/ (this.f_mainContainer__org_patternfly_component_tabs_Tabs_.m_element__elemental2_dom_HTMLElement()), 'Horizontal overflow is not supported for vertical tabs!');
   }
   ...
   if (this.f_overflowHorizontal__org_patternfly_component_tabs_Tabs_) {
    if (!$Equality.$same(this.f_addHandler__org_patternfly_component_tabs_Tabs_, null)) {
     Logger.m_wrong__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Overflow tabs should not have an onAdd() handler.');
    }
  ...
  if (this.f_tabs__org_patternfly_component_tabs_Tabs_.isEmpty()) {
   Logger.m_missing__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {Element}*/ (this.f_mainContainer__org_patternfly_component_tabs_Tabs_.m_element__elemental2_dom_HTMLElement()), 'No tabs given!');
  } else {
 ...
 m_ariaAddLabel__java_lang_String__org_patternfly_component_tabs_Tabs(/** ?string */ label) {
  if (!$Equality.$same(this.f_addButton__org_patternfly_component_tabs_Tabs_, null)) {
   ...
   Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Unable to set aria add label. Please make call onAdd() first.');
  }
  return this;
 }
 /** @nodts @return {Tabs} */
 ...
 m_box__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {Tabs}*/ ($Casts.$to(Box.m_box__$default__org_patternfly_style_Modifiers_Box__boolean__org_jboss_elemento_TypedBuilder(this, arg0), Tabs));
 }
 ...
 //Default method forwarding stub.
 /** @nodts @return {Tabs} */
 m_box__boolean__org_patternfly_component_tabs_Tabs(/** boolean */ arg0) {
  return /**@type {Tabs}*/ ($Casts.$to(Box.m_box__$default__org_patternfly_style_Modifiers_Box__boolean__org_jboss_elemento_TypedBuilder(this, arg0), Tabs));
 }
 //Default method forwarding stub.
 /** @nodts @return {Tabs} */
