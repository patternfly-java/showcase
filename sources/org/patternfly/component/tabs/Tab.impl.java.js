...
class Tab extends TabSubComponent {
 ...
 m_closeable__org_patternfly_handler_CloseHandler__org_patternfly_component_tabs_Tab(/** CloseHandler<Tab> */ closeHandler) {
  if ($Equality.$same(this.f_closeButton__org_patternfly_component_tabs_Tab_, null)) {
   ...
   }), Button)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_span__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_tabs__org_patternfly_style_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_item__org_patternfly_style_Classes, Classes.f_action__org_patternfly_style_Classes, Classes.f_icon__org_patternfly_style_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(PredefinedIcon.f_times__org_patternfly_style_PredefinedIcon)), HTMLContainerBuilder))), Button))), HTMLContainerBuilder)));
  }
  return this.m_onClose__org_patternfly_handler_CloseHandler__org_patternfly_component_tabs_Tab(closeHandler);
 }
 /** @nodts @return {Tab} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_tabs_Tab(/** InlineIcon */ icon) {
  ...
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_tabs_Tab().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {Tab} */
 ...
 m_ariaHelpLabel__java_lang_String__org_patternfly_component_tabs_Tab(/** ?string */ label) {
  if (!$Equality.$same(this.f_helpButton__org_patternfly_component_tabs_Tab, null)) {
   ...
   Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Tabs__org_patternfly_component_ComponentType, this.m_element__elemental2_dom_HTMLElement(), 'Unable to set aria help label for tab ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_id__org_patternfly_component_tabs_Tab) + '. Please add the help popover first.');
  }
  return this;
 }
 /** @nodts @return {Tab} */
   ...
   if ($Equality.$same(this.f_content__org_patternfly_component_tabs_Tab, null)) {
    if (!$Equality.$same(this.f_dynamicContent__org_patternfly_component_tabs_Tab, null)) {
     ...
     /**@type {Promise<*>}*/ (/**@type {Promise<*>}*/ (/**@type {Promise<TabContent>}*/ ($Casts.$to(this.f_dynamicContent__org_patternfly_component_tabs_Tab.m_apply__java_lang_Object__java_lang_Object(tabs), Promise_$Overlay)).then((c) =>{
      ...
      Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Tabs__org_patternfly_component_ComponentType, this.m_element__elemental2_dom_HTMLElement(), 'Unable to load content for tab ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_id__org_patternfly_component_tabs_Tab) + ': ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(error));
      return null;
     })).finally(() =>{
      this.m_stopLoading__void_$p_org_patternfly_component_tabs_Tab();
     });
    } else {
     Logger.m_missing__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Tabs__org_patternfly_component_ComponentType, this.m_element__elemental2_dom_HTMLElement(), 'No content defined for tab ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_id__org_patternfly_component_tabs_Tab));
    }
   } else {
    this.f_content__org_patternfly_component_tabs_Tab.m_element__elemental2_dom_HTMLElement().hidden = false;
   }
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {Tab}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), Tab));
 }
 //Bridge method.
 /** @final @override @nodts @return {Tab} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {Tab}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), Tab));
 }
 //Bridge method.
 /** @final @override @nodts @return {Tab} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_tabs_Tab(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {Tab} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {Tab} */
 m_icon__java_lang_String__org_patternfly_component_tabs_Tab(/** ?string */ arg0) {
  return /**@type {Tab}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), Tab));
 }
 //Default method forwarding stub.
 /** @nodts @return {Tab} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_tabs_Tab(/** PredefinedIcon */ arg0) {
  return /**@type {Tab}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), Tab));
 }
 /** @nodts */
 static $clinit() {
