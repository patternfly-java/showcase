...
class OverflowTab extends TabSubComponent {
 ...
 $ctor__org_patternfly_component_tabs_OverflowTab__void() {
  ...
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_menu__org_patternfly_component_tabs_OverflowTab_ = Menu.m_menu__org_patternfly_core_SelectionMode__org_patternfly_component_menu_Menu(SelectionMode.f_single__org_patternfly_core_SelectionMode).m_onSingleSelect__org_patternfly_handler_SelectHandler__org_patternfly_component_menu_Menu(SelectHandler.$adapt((/** Event */ event, menuItem, /** boolean */ selected) =>{
  ...
  this.f_popper__org_patternfly_component_tabs_OverflowTab_ = PopperBuilder.$create__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__elemental2_dom_HTMLElement(ComponentType.f_Tabs__org_patternfly_component_ComponentType, /**@type {HTMLButtonElement}*/ ($Casts.$to(this.f_button__org_patternfly_component_tabs_OverflowTab_.m_element__elemental2_dom_HTMLElement(), $Overlay)), /**@type {HTMLDivElement}*/ ($Casts.$to(this.f_menu__org_patternfly_component_tabs_OverflowTab_.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay))).m_zIndex__int__org_patternfly_thirdparty_popper_PopperBuilder(9999).m_placement__org_patternfly_thirdparty_popper_Placement__org_patternfly_thirdparty_popper_PopperBuilder(Placement.f_bottomStart__org_patternfly_thirdparty_popper_Placement).m_addModifier__arrayOf_org_patternfly_thirdparty_popper_Modifier__org_patternfly_thirdparty_popper_PopperBuilder([Modifiers.m_noOverflow__org_patternfly_thirdparty_popper_Modifier(), Modifiers.m_hide__org_patternfly_thirdparty_popper_Modifier(), Modifiers.m_flip__boolean__org_patternfly_thirdparty_popper_Modifier(true), Modifiers.m_placement__org_patternfly_thirdparty_popper_Modifier(), Modifiers.m_eventListeners__boolean__org_patternfly_thirdparty_popper_Modifier(false)]).m_registerHandler__elemental2_dom_HTMLElement__java_util_Set__java_util_function_Consumer__java_util_function_Consumer__org_patternfly_thirdparty_popper_PopperBuilder(/**@type {HTMLButtonElement}*/ ($Casts.$to(this.f_button__org_patternfly_component_tabs_OverflowTab_.m_element__elemental2_dom_HTMLElement(), $Overlay)), /**@type {EnumSet<TriggerAction>}*/ (EnumSet.m_of__java_lang_Enum__java_util_EnumSet(TriggerAction.f_click__org_patternfly_thirdparty_popper_TriggerAction)), Consumer.$adapt((arg0) =>{
