...
class Spinner extends BaseComponentSVG {
 ...
 /** @nodts @return {Spinner} */
 m_size__org_patternfly_layout_Size__org_patternfly_component_spinner_Spinner(/** Size */ size) {
  return /**@type {Spinner}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([size.f_modifier__org_patternfly_layout_Size], j_l_String))), Spinner));
 }
 /** @nodts @return {Spinner} */
 ...
 m_inline__org_jboss_elemento_TypedBuilder() {
  return /**@type {Spinner}*/ ($Casts.$to(Inline.m_inline__$default__org_patternfly_core_Modifiers_Inline__org_jboss_elemento_TypedBuilder(this), Spinner));
 }
 //Bridge method.
 /** @final @override @nodts @return {Spinner} */
 m_inline__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {Spinner}*/ ($Casts.$to(Inline.m_inline__$default__org_patternfly_core_Modifiers_Inline__boolean__org_jboss_elemento_TypedBuilder(this, arg0), Spinner));
 }
