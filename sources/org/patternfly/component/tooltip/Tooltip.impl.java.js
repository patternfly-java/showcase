...
class Tooltip extends BaseComponent {
 ...
 /** @nodts @return {Tooltip} */
 m_placement__org_patternfly_thirdparty_popper_Placement__org_patternfly_component_tooltip_Tooltip(/** Placement */ placement) {
