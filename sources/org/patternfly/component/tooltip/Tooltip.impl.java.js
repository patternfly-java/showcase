  ...
  if (!$Equality.$same(this.f_trigger__org_patternfly_component_tooltip_Tooltip_, null)) {
   ...
   if (!$Equality.$same(triggerElement, null)) {
    if (Elements.m_isAttached__elemental2_dom_Node__boolean(triggerElement)) {
     ...
     Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)), 'Trigger element ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(Elements.m_toString__elemental2_dom_Element__java_lang_String(triggerElement)) + ' is not attached');
    }
   } else {
