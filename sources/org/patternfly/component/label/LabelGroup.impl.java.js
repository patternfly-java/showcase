...
class LabelGroup extends BaseComponent {
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  ...
  for (let $iterator = this.f_labels__org_patternfly_component_label_LabelGroup_.values().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   ...
   {
    label.m_passComponent__org_patternfly_component_label_LabelGroup__void(this);
   }
  }
 }
 ...
 m_category__java_lang_String__org_patternfly_component_label_LabelGroup(/** ?string */ category) {
  if ($Equality.$same(this.f_categoryElement__org_patternfly_component_label_LabelGroup_, null)) {
   this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_category__org_patternfly_layout_Classes)], j_l_String)));
 ...
 m_closable__org_patternfly_handler_CloseHandler__org_patternfly_component_label_LabelGroup(/** CloseHandler<LabelGroup> */ closeHandler) {
  ...
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_labelGroup__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_close__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_closeButton__org_patternfly_component_label_LabelGroup_ = /**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_layout_PredefinedIcon__java_lang_String__org_patternfly_component_button_Button(PredefinedIcon.f_timesCircle__org_patternfly_layout_PredefinedIcon, 'Close label group').m_plain__org_jboss_elemento_TypedBuilder(), Button)).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(closeId), Button)).m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Aria.f_labelledBy__org_patternfly_core_Aria, labelledBy), Button)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (event) =>{
 ...
 m_vertical__org_patternfly_component_label_LabelGroup() {
  return /**@type {LabelGroup}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_vertical__org_patternfly_layout_Classes)], j_l_String))), LabelGroup));
 }
 /** @nodts @return {LabelGroup} */
 ...
 m_overflow__void_$p_org_patternfly_component_label_LabelGroup() {
  if (this.f_labels__org_patternfly_component_label_LabelGroup_.size() > this.f_numLabels__org_patternfly_component_label_LabelGroup_ && $Equality.$same(this.f_overflowItem__org_patternfly_component_label_LabelGroup_, null) && $Equality.$same(this.f_overflowLabel__org_patternfly_component_label_LabelGroup_, null)) {
   this.f_overflowItem__org_patternfly_component_label_LabelGroup_ = /**@type {HTMLLIElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_chipGroup__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_list__org_patternfly_layout_Classes, Classes.f_item__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_overflowLabel__org_patternfly_component_label_LabelGroup_ = /**@type {Label}*/ ($Casts.$to(/**@type {Label}*/ ($Casts.$to(Label.$create__org_jboss_elemento_HTMLContainerBuilder__java_lang_String__org_patternfly_layout_Color(Elements.m_button__org_jboss_elemento_HTMLContainerBuilder(), '', Color.f_grey__org_patternfly_layout_Color).m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_overflow__org_patternfly_layout_Classes)], j_l_String))), Label)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (event) =>{
    let event_1 = /**@type {MouseEvent}*/ ($Casts.$to(event, MouseEvent_$Overlay));
