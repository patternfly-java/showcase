...
class FormControl extends BaseComponent {
 ...
 /** @nodts @return {B} */
 m_validated__org_patternfly_core_ValidationStatus__org_patternfly_component_BaseComponent(/** ValidationStatus */ status) {
  if (!$Equality.$same(status, this.f_status__org_patternfly_component_form_FormControl)) {
   if (!$Equality.$same(this.f_status__org_patternfly_component_form_FormControl, null)) {
    if (!$Equality.$same(this.f_status__org_patternfly_component_form_FormControl.f_modifier__org_patternfly_core_ValidationStatus, null)) {
     /**@type {!Element}*/ (this.m_element__elemental2_dom_HTMLElement()).classList.remove(this.f_status__org_patternfly_component_form_FormControl.f_modifier__org_patternfly_core_ValidationStatus);
    }
    if (!$Equality.$same(this.f_status__org_patternfly_component_form_FormControl.f_icon__org_patternfly_core_ValidationStatus, null)) {
   ...
   if (!$Equality.$same(status.f_modifier__org_patternfly_core_ValidationStatus, null)) {
   ...
   if (!$Equality.$same(status, ValidationStatus.f_default___org_patternfly_core_ValidationStatus) && !$Equality.$same(status.f_icon__org_patternfly_core_ValidationStatus, null)) {
    this.m_failSafeValidatedContainer__elemental2_dom_HTMLElement_$pp_org_patternfly_component_form().appendChild(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(status.f_icon__org_patternfly_core_ValidationStatus).m_element__elemental2_dom_HTMLElement());
   }
  }
