...
class TextInput extends FormControl {
 ...
 /** @nodts @return {TextInput} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_form_TextInput(/** InlineIcon */ icon) {
  ...
  this.f_iconContainer__org_patternfly_component_form_TextInput_.appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {TextInput} */
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {TextInput}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), TextInput));
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInput} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {TextInput}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), TextInput));
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInput} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_form_TextInput(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInput} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {TextInput} */
 m_icon__java_lang_String__org_patternfly_component_form_TextInput(/** ?string */ arg0) {
  return /**@type {TextInput}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), TextInput));
 }
 //Default method forwarding stub.
 /** @nodts @return {TextInput} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_form_TextInput(/** PredefinedIcon */ arg0) {
  return /**@type {TextInput}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), TextInput));
 }
 /** @nodts */
 static $clinit() {
