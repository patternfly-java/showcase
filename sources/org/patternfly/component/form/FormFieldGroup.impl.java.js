...
class FormFieldGroup extends FormSubComponent {
 ...
 m_collapse__boolean__void(/** boolean */ fireEvent) {
  if (!this.f_expandable__org_patternfly_component_form_FormFieldGroup_) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Form__org_patternfly_component_ComponentType, this.m_element__elemental2_dom_HTMLElement(), 'Form field group is not expandable.\n' + 'Please use FormFieldGroup.expandable() to make this an expandable field group.');
   return;
  }
