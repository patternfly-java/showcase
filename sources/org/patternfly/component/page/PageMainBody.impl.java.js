...
/**
 * @extends {SubComponent<HTMLDivElement, PageMainBody>}
 */
class PageMainBody extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
 }
