...
class Popover extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {HTMLElement} @nodts*/
  this.f_headerElement__org_patternfly_component_popover_Popover_;
  /**@type {HTMLElement} @nodts*/
 ...
 $ctor__org_patternfly_component_popover_Popover__java_util_function_Supplier__void(/** Supplier<HTMLElement> */ trigger) {
  ...
  this.f_placement__org_patternfly_component_popover_Popover_ = Placement.f_top__org_patternfly_thirdparty_popper_Placement;
 ...
 m_addHeader__java_lang_String__org_patternfly_component_popover_Popover(/** ?string */ header) {
  this.m_failSafeHeaderElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_popover_Popover().textContent = header;
  return this;
 }
 /** @nodts @return {Popover} */
 m_addIcon__java_lang_String__org_patternfly_component_popover_Popover(/** ?string */ iconClass) {
  return this.m_addIcon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_popover_Popover(InlineIcon.m_inlineIcon__java_lang_String__org_patternfly_component_icon_InlineIcon(iconClass));
 }
 /** @nodts @return {Popover} */
 m_addIcon__org_patternfly_layout_PredefinedIcon__org_patternfly_component_popover_Popover(/** PredefinedIcon */ icon) {
  return this.m_addIcon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_popover_Popover(InlineIcon.m_inlineIcon__org_patternfly_layout_PredefinedIcon__org_patternfly_component_icon_InlineIcon(icon));
 }
 /** @nodts @return {Popover} */
 m_addIcon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_popover_Popover(/** InlineIcon */ icon) {
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_popover_Popover().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {Popover} */
 ...
 m_autoWidth__org_patternfly_component_popover_Popover() {
  return /**@type {Popover}*/ ($Casts.$to(this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_widthAuto__org_patternfly_layout_Classes)], j_l_String))), Popover));
 }
 /** @nodts @return {Popover} */
 ...
 /** @nodts @return {Popover} */
 m_placement__org_patternfly_thirdparty_popper_Placement__org_patternfly_component_popover_Popover(/** Placement */ placement) {
  if ($Equality.$same(placement, Placement.f_auto__org_patternfly_thirdparty_popper_Placement)) {
   this.f_flip__org_patternfly_component_popover_Popover_ = true;
  }
 ...
 /** @nodts @return {Popover} */
 m_severity__org_patternfly_core_Severity__org_patternfly_component_popover_Popover(/** Severity */ severity) {
  return this.m_severity__org_patternfly_core_Severity__java_lang_String__org_patternfly_component_popover_Popover(severity, severity.f_aria__org_patternfly_core_Severity);
 }
 /** @nodts @return {Popover} */
 m_severity__org_patternfly_core_Severity__java_lang_String__org_patternfly_component_popover_Popover(/** Severity */ severity, /** ?string */ screenReaderText) {
  ...
  this.m_addIcon__org_patternfly_layout_PredefinedIcon__org_patternfly_component_popover_Popover(severity.f_icon__org_patternfly_core_Severity);
 ...
 /** @nodts @return {Popover} */
 m_trigger__arrayOf_org_patternfly_thirdparty_popper_TriggerAction__org_patternfly_component_popover_Popover(/** Array<TriggerAction> */ trigger) {
  if (!$Equality.$same(trigger, null)) {
   this.f_triggerActions__org_patternfly_component_popover_Popover_.clear();
   this.f_triggerActions__org_patternfly_component_popover_Popover_.addAll(/**@type {List<TriggerAction>}*/ (Arrays.m_asList__arrayOf_java_lang_Object__java_util_List(trigger)));
  }
  return this;
 }
 /** @nodts @return {Popover} */
 ...
 m_show__elemental2_dom_Event__void(/** Event */ event) {
  this.f_popper__org_patternfly_component_popover_Popover_.m_show__org_patternfly_handler_Callback__void(null);
 }
 /** @override @nodts */
 m_close__elemental2_dom_Event__boolean__void(/** Event */ event, /** boolean */ fireEvent) {
  if (CloseHandler.m_shouldClose__java_lang_Object__org_patternfly_handler_CloseHandler__elemental2_dom_Event__boolean__boolean(this, this.f_closeHandler__org_patternfly_component_popover_Popover_, event, fireEvent)) {
   this.f_popper__org_patternfly_component_popover_Popover_.m_hide__org_patternfly_handler_Callback__void(Callback.$adapt(() =>{
 ...
 m_failSafeHeaderElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_popover_Popover() {
  if ($Equality.$same(this.f_headerElement__org_patternfly_component_popover_Popover_, null)) {
   let headerId = Id.m_unique__java_lang_String__arrayOf_java_lang_String__java_lang_String(this.m_componentType__org_patternfly_component_ComponentType().f_id__org_patternfly_component_ComponentType, /**@type {!Array<?string>}*/ ($Arrays.$init(['header'], j_l_String)));
   this.f_contentElement__org_patternfly_component_popover_Popover_.appendChild(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_header__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_popover__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_header__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_popover__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_title__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(headerId), HTMLContainerBuilder)).m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(this.f_headerElement__org_patternfly_component_popover_Popover_ = /**@type {HTMLHeadingElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLHeadingElement>}*/ ($Casts.$to(Elements.m_h__int__org_jboss_elemento_HTMLContainerBuilder(6).m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_popover__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_title__org_patternfly_layout_Classes, Classes.f_text__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLHeadingElement_$Overlay))), HTMLContainerBuilder))), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement());
   this.m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Aria.f_labelledBy__org_patternfly_core_Aria, headerId);
  }
  return this.f_headerElement__org_patternfly_component_popover_Popover_;
 }
 /** @nodts @return {HTMLElement} */
 ...
 m_noPadding__org_jboss_elemento_TypedBuilder() {
  return /**@type {Popover}*/ ($Casts.$to(NoPadding.m_noPadding__$default__org_patternfly_core_Modifiers_NoPadding__org_jboss_elemento_TypedBuilder(this), Popover));
 }
 //Bridge method.
 /** @final @override @nodts @return {Popover} */
 m_noPadding__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {Popover}*/ ($Casts.$to(NoPadding.m_noPadding__$default__org_patternfly_core_Modifiers_NoPadding__boolean__org_jboss_elemento_TypedBuilder(this, arg0), Popover));
 }
 //Default method forwarding stub.
 /** @nodts @return {Popover} */
