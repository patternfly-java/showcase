...
class Popover extends BaseComponent {
 ...
 /** @nodts @return {Popover} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_popover_Popover(/** InlineIcon */ icon) {
 ...
 /** @nodts @return {Popover} */
 m_triggerActions__arrayOf_org_patternfly_thirdparty_popper_TriggerAction__org_patternfly_component_popover_Popover(/** Array<TriggerAction> */ triggerActions) {
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {Popover}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), Popover));
 }
 //Bridge method.
 /** @final @override @nodts @return {Popover} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {Popover}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), Popover));
 }
 //Bridge method.
 /** @final @override @nodts @return {Popover} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_popover_Popover(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {Popover} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {Popover} */
 m_icon__java_lang_String__org_patternfly_component_popover_Popover(/** ?string */ arg0) {
  return /**@type {Popover}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), Popover));
 }
 //Default method forwarding stub.
 /** @nodts @return {Popover} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_popover_Popover(/** PredefinedIcon */ arg0) {
  return /**@type {Popover}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), Popover));
 }
 /** @nodts */
 static $clinit() {
