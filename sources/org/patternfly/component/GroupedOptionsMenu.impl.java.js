goog.module('org.patternfly.component.GroupedOptionsMenu$impl');
...
let Group = goog.forwardDeclare('org.patternfly.component.GroupedOptionsMenu.Group$impl');
...
/**
 * @extends {BaseComponent<HTMLDivElement, GroupedOptionsMenu>}
 * @implements {Disabled<HTMLDivElement, GroupedOptionsMenu>}
 * @deprecated
 */
class GroupedOptionsMenu extends BaseComponent {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {CollapseExpand} @nodts*/
  this.f_ceh__org_patternfly_component_GroupedOptionsMenu_;
  /**@type {HTMLButtonElement} @nodts*/
  this.f_button__org_patternfly_component_GroupedOptionsMenu_;
  /**@type {HTMLElement} @nodts*/
  this.f_plain__org_patternfly_component_GroupedOptionsMenu_;
  /**@type {HTMLElement} @nodts*/
  this.f_menu__org_patternfly_component_GroupedOptionsMenu_;
  /**@type {boolean} @nodts*/
  this.f_collapseOnSelect__org_patternfly_component_GroupedOptionsMenu_ = false;
 }
 /** @nodts @return {GroupedOptionsMenu} */
 static m_text__java_lang_String__org_patternfly_component_GroupedOptionsMenu(/** ?string */ text) {
  GroupedOptionsMenu.$clinit();
  return GroupedOptionsMenu.$create__java_lang_String__org_patternfly_component_Icon__boolean(text, null, false);
 }
 /** @nodts @return {GroupedOptionsMenu} */
 static m_icon__org_patternfly_component_Icon__org_patternfly_component_GroupedOptionsMenu(/** Icon */ icon) {
  GroupedOptionsMenu.$clinit();
  return GroupedOptionsMenu.$create__java_lang_String__org_patternfly_component_Icon__boolean(null, icon, false);
 }
 /** @nodts @return {GroupedOptionsMenu} */
 static m_plain__java_lang_String__org_patternfly_component_GroupedOptionsMenu(/** ?string */ text) {
  GroupedOptionsMenu.$clinit();
  return GroupedOptionsMenu.$create__java_lang_String__org_patternfly_component_Icon__boolean(text, null, true);
 }
 /** @nodts @return {!GroupedOptionsMenu} */
 static $create__java_lang_String__org_patternfly_component_Icon__boolean(/** ?string */ text, /** Icon */ icon, /** boolean */ plain) {
  GroupedOptionsMenu.$clinit();
  let $instance = new GroupedOptionsMenu();
  $instance.$ctor__org_patternfly_component_GroupedOptionsMenu__java_lang_String__org_patternfly_component_Icon__boolean__void(text, icon, plain);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_GroupedOptionsMenu__java_lang_String__org_patternfly_component_Icon__boolean__void(/** ?string */ text, /** Icon */ icon, /** boolean */ plain) {
  ...
  this.f_ceh__org_patternfly_component_GroupedOptionsMenu_ = CollapseExpand.$create__();
  this.f_collapseOnSelect__org_patternfly_component_GroupedOptionsMenu_ = false;
 ...
 /** @nodts @return {GroupedOptionsMenu} */
 m_that__org_patternfly_component_GroupedOptionsMenu() {
  return this;
 }
 /** @nodts @return {HTMLElement} */
 m_buttonElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_GroupedOptionsMenu() {
  return this.f_button__org_patternfly_component_GroupedOptionsMenu_;
 }
 /** @nodts @return {HTMLElement} */
 m_menuElement__elemental2_dom_HTMLElement_$p_org_patternfly_component_GroupedOptionsMenu() {
  return this.f_menu__org_patternfly_component_GroupedOptionsMenu_;
 }
 /** @nodts @template T @return {GroupedOptionsMenu} */
 m_add__org_patternfly_component_GroupedOptionsMenu_Group__org_patternfly_component_GroupedOptionsMenu(/** Group<T> */ group) {
  if (this.f_menu__org_patternfly_component_GroupedOptionsMenu_.childNodes.length != 0) {
   this.f_menu__org_patternfly_component_GroupedOptionsMenu_.appendChild(/**@type {HTMLLIElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_optionsMenu__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_separator__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_attr__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder('role', Classes.f_separator__org_patternfly_layout_Classes), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLLIElement_$Overlay)));
  }
  this.f_menu__org_patternfly_component_GroupedOptionsMenu_.appendChild(/**@type {HTMLLIElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder('label', group.f_text__org_patternfly_component_GroupedOptionsMenu_Group_), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(group), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLLIElement_$Overlay)));
  for (let $iterator = group.f_items__org_patternfly_component_GroupedOptionsMenu_Group_.m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   let item = $iterator.m_next__java_lang_Object();
   {
    let button = /**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLButtonElement>}*/ ($Casts.$to(Elements.m_button__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_optionsMenu__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_menu__org_patternfly_layout_Classes, Classes.f_item__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_attr__java_lang_String__int__org_jboss_elemento_TypedBuilder('tabindex', - 1 | 0), HTMLContainerBuilder)).m_data__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Dataset.f_multiOptionsMenuItem__org_patternfly_core_Dataset, group.f_itemDisplay__org_patternfly_component_GroupedOptionsMenu_Group_.m_itemId__java_lang_Object__java_lang_String(item)), HTMLContainerBuilder)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (e) =>{
     let e_1 = /**@type {MouseEvent}*/ ($Casts.$to(e, MouseEvent_$Overlay));
     if (this.f_collapseOnSelect__org_patternfly_component_GroupedOptionsMenu_) {
     ...
     group.m_select__java_lang_Object__org_patternfly_component_GroupedOptionsMenu_Group(item);
    }), HTMLContainerBuilder));
    group.f_itemDisplay__org_patternfly_component_GroupedOptionsMenu_Group_.f_display__org_patternfly_component_OldItemDisplay.m_accept__java_lang_Object__java_lang_Object__void(button, item);
    let /** HTMLElement */ icon;
    button.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(icon = /**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLElement>}*/ ($Casts.$to(Elements.m_i__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([PredefinedIcon.f_check__org_patternfly_layout_PredefinedIcon.f_className__org_patternfly_layout_PredefinedIcon, Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_optionsMenu__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_menu__org_patternfly_layout_Classes, Classes.f_item__org_patternfly_layout_Classes, 'icon'], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_aria__java_lang_String__boolean__org_jboss_elemento_TypedBuilder('hidden', true), HTMLContainerBuilder)).m_data__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Dataset.f_multiOptionsMenuCheck__org_patternfly_core_Dataset, group.f_itemDisplay__org_patternfly_component_GroupedOptionsMenu_Group_.m_itemId__java_lang_Object__java_lang_String(item)), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement());
    Elements.m_setVisible__elemental2_dom_HTMLElement__boolean__void(icon, false);
    group.m_element__elemental2_dom_HTMLElement().appendChild(/**@type {HTMLLIElement}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLLIElement>}*/ ($Casts.$to(Elements.m_li__org_jboss_elemento_HTMLContainerBuilder().m_attr__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder('role', Classes.f_menuitem__org_patternfly_layout_Classes), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(button), HTMLContainerBuilder)).m_element__elemental2_dom_HTMLElement(), HTMLLIElement_$Overlay)));
   }
  }
  return this;
 }
 /** @nodts @return {GroupedOptionsMenu} */
 m_up__org_patternfly_component_GroupedOptionsMenu() {
 ...
 /** @nodts @return {GroupedOptionsMenu} */
 m_right__org_patternfly_component_GroupedOptionsMenu() {
  this.f_menu__org_patternfly_component_GroupedOptionsMenu_.classList.add(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_alignRight__org_patternfly_layout_Classes));
  return this;
 }
 /** @nodts @return {GroupedOptionsMenu} */
 m_collapseOnSelect__org_patternfly_component_GroupedOptionsMenu() {
  this.f_collapseOnSelect__org_patternfly_component_GroupedOptionsMenu_ = true;
  return this;
 }
 /** @nodts @return {GroupedOptionsMenu} */
 m_disabled__boolean__org_patternfly_component_GroupedOptionsMenu(/** boolean */ disabled) {
  this.f_button__org_patternfly_component_GroupedOptionsMenu_.disabled = disabled;
  if (!$Equality.$same(this.f_plain__org_patternfly_component_GroupedOptionsMenu_, null)) {
   if (disabled) {
    this.f_plain__org_patternfly_component_GroupedOptionsMenu_.classList.add(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_disabled__org_patternfly_layout_Classes));
   } else {
    this.f_plain__org_patternfly_component_GroupedOptionsMenu_.classList.remove(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_disabled__org_patternfly_layout_Classes));
   }
  }
  return this;
 }
 //Bridge method.
 /** @final @override @nodts @return {GroupedOptionsMenu} */
 m_that__org_jboss_elemento_TypedBuilder() {
  return this.m_that__org_patternfly_component_GroupedOptionsMenu();
 }
 //Bridge method.
 /** @final @override @nodts @return {GroupedOptionsMenu} */
 m_disabled__org_jboss_elemento_TypedBuilder() {
  return /**@type {GroupedOptionsMenu}*/ ($Casts.$to(Disabled.m_disabled__$default__org_patternfly_core_Modifiers_Disabled__org_jboss_elemento_TypedBuilder(this), GroupedOptionsMenu));
 }
 //Bridge method.
 /** @final @override @nodts @return {GroupedOptionsMenu} */
 m_disabled__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return this.m_disabled__boolean__org_patternfly_component_GroupedOptionsMenu(arg0);
 }
 //Default method forwarding stub.
 /** @nodts @return {GroupedOptionsMenu} */
 m_disabled__org_patternfly_component_GroupedOptionsMenu() {
  return /**@type {GroupedOptionsMenu}*/ ($Casts.$to(Disabled.m_disabled__$default__org_patternfly_core_Modifiers_Disabled__org_jboss_elemento_TypedBuilder(this), GroupedOptionsMenu));
 }
 /** @nodts */
 static $clinit() {
  GroupedOptionsMenu.$clinit = () =>{};
  GroupedOptionsMenu.$loadModules();
  BaseComponent.$clinit();
  Disabled.$clinit();
 }
 /** @nodts @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof GroupedOptionsMenu;
 }
...
Disabled.$markImplementor(GroupedOptionsMenu);
$Util.$setClassMetadata(GroupedOptionsMenu, 'org.patternfly.component.GroupedOptionsMenu');

exports = GroupedOptionsMenu;

//# sourceMappingURL=GroupedOptionsMenu.js.map
