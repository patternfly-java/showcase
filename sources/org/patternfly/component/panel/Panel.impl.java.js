...
class Panel extends BaseComponentFlat {
 ...
 m_add__org_patternfly_component_panel_PanelHeader__org_patternfly_component_panel_Panel(/** PanelHeader */ header) {
  if (!$Equality.$same(this.f_header__org_patternfly_component_panel_Panel_, null)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {HTMLDivElement}*/ ($Casts.$to(this.f_header__org_patternfly_component_panel_Panel_.m_element__elemental2_dom_HTMLElement(), $Overlay)), 'Header already added');
  }
 ...
 m_add__org_patternfly_component_panel_PanelMain__org_patternfly_component_panel_Panel(/** PanelMain */ main) {
  if (!$Equality.$same(this.f_main__org_patternfly_component_panel_Panel_, null)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.f_main__org_patternfly_component_panel_Panel_.m_element__elemental2_dom_HTMLElement(), 'Main already added');
  }
 ...
 m_add__org_patternfly_component_panel_PanelFooter__org_patternfly_component_panel_Panel(/** PanelFooter */ footer) {
  if (!$Equality.$same(this.f_footer__org_patternfly_component_panel_Panel_, null)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {HTMLDivElement}*/ ($Casts.$to(this.f_footer__org_patternfly_component_panel_Panel_.m_element__elemental2_dom_HTMLElement(), $Overlay)), 'Footer already added');
  }
