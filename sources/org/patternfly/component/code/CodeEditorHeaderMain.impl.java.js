...
/**
 * @extends {SubComponent<HTMLDivElement, CodeEditorHeaderMain>}
 */
class CodeEditorHeaderMain extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
 }
