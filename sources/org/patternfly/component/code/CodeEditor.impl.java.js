...
const Readonly2 = goog.require('org.patternfly.core.Modifiers.Readonly2$impl');
...
class CodeEditor extends BaseComponent {
 ...
 constructor() {
  ...
  /**@type {CodeEditorHeader} @nodts*/
  this.f_header__org_patternfly_component_code_CodeEditor_;
 }
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (!$Equality.$same(this.f_header__org_patternfly_component_code_CodeEditor_, null)) {
   this.f_header__org_patternfly_component_code_CodeEditor_.m_passComponent__org_patternfly_component_code_CodeEditor__void(this);
  }
 }
 /** @nodts @return {CodeEditor} */
 ...
 m_add__org_patternfly_component_code_CodeEditorHeader__org_patternfly_component_code_CodeEditor(/** CodeEditorHeader */ header) {
  this.f_header__org_patternfly_component_code_CodeEditor_ = header;
 ...
 m_readonly__org_jboss_elemento_TypedBuilder() {
  return /**@type {CodeEditor}*/ ($Casts.$to(Readonly2.m_readonly__$default__org_patternfly_core_Modifiers_Readonly2__org_jboss_elemento_TypedBuilder(this), CodeEditor));
 }
 //Bridge method.
 /** @final @override @nodts @return {CodeEditor} */
 m_readonly__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {CodeEditor}*/ ($Casts.$to(Readonly2.m_readonly__$default__org_patternfly_core_Modifiers_Readonly2__boolean__org_jboss_elemento_TypedBuilder(this, arg0), CodeEditor));
 }
 //Default method forwarding stub.
 /** @nodts @return {CodeEditor} */
...
Attachable.$markImplementor(CodeEditor);
