...
class CodeBlockAction extends CodeBlockSubComponent {
 ...
 static m_codeBlockAction__java_lang_String__org_patternfly_component_code_CodeBlockAction(/** ?string */ iconClass) {
  ...
  return CodeBlockAction.$create__org_patternfly_component_icon_InlineIcon(InlineIcon.m_inlineIcon__java_lang_String__org_patternfly_component_icon_InlineIcon(iconClass));
 }
 /** @nodts @return {CodeBlockAction} */
 static m_codeBlockAction__org_patternfly_style_PredefinedIcon__org_patternfly_component_code_CodeBlockAction(/** PredefinedIcon */ predefinedIcon) {
  CodeBlockAction.$clinit();
  return CodeBlockAction.$create__org_patternfly_component_icon_InlineIcon(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(predefinedIcon));
 }
 /** @nodts @return {CodeBlockAction} */
 static m_codeBlockAction__org_patternfly_component_icon_InlineIcon__org_patternfly_component_code_CodeBlockAction(/** InlineIcon */ icon) {
  CodeBlockAction.$clinit();
  return CodeBlockAction.$create__org_patternfly_component_icon_InlineIcon(icon);
 }
 /** @nodts @return {CodeBlockAction} */
 ...
 static m_codeBlockCopyToClipboardAction__java_lang_String__java_lang_String__org_patternfly_component_code_CodeBlockAction(/** ?string */ copyText, /** ?string */ copiedText) {
  ...
  return /**@type {CodeBlockAction}*/ ($Casts.$to(CodeBlockAction.$create__org_patternfly_component_icon_InlineIcon(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(PredefinedIcon.f_copy__org_patternfly_style_PredefinedIcon)).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(copyId), CodeBlockAction)).m_ariaLabel__java_lang_String__org_patternfly_component_code_CodeBlockAction(copyText).m_onClick__org_patternfly_handler_ComponentHandler__org_patternfly_component_code_CodeBlockAction(ComponentHandler.$adapt((/** Event */ event, codeBlock) =>{
 ...
 /** @nodts @return {!CodeBlockAction} */
 static $create__org_patternfly_component_icon_InlineIcon(/** InlineIcon */ icon) {
  CodeBlockAction.$clinit();
  let $instance = new CodeBlockAction();
  $instance.$ctor__org_patternfly_component_code_CodeBlockAction__org_patternfly_component_icon_InlineIcon__void(icon);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_code_CodeBlockAction__org_patternfly_component_icon_InlineIcon__void(/** InlineIcon */ icon) {
  ...
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_button__org_patternfly_component_code_CodeBlockAction_ = /**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_component_button_Button().m_plain__org_jboss_elemento_TypedBuilder(), Button)).m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_button_Button(icon));
 }
 /** @nodts @return {CodeBlockAction} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_code_CodeBlockAction(/** InlineIcon */ icon) {
  this.f_button__org_patternfly_component_code_CodeBlockAction_.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_button_Button(icon);
  return this;
 }
 /** @nodts @return {CodeBlockAction} */
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {CodeBlockAction}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CodeBlockAction));
 }
 //Bridge method.
 /** @final @override @nodts @return {CodeBlockAction} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {CodeBlockAction}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), CodeBlockAction));
 }
 //Bridge method.
 /** @final @override @nodts @return {CodeBlockAction} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_code_CodeBlockAction(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {CodeBlockAction} */
 ...
 /** @nodts @return {CodeBlockAction} */
 m_icon__java_lang_String__org_patternfly_component_code_CodeBlockAction(/** ?string */ arg0) {
  return /**@type {CodeBlockAction}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), CodeBlockAction));
 }
 //Default method forwarding stub.
 /** @nodts @return {CodeBlockAction} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_code_CodeBlockAction(/** PredefinedIcon */ arg0) {
  return /**@type {CodeBlockAction}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), CodeBlockAction));
 }
 /** @nodts */
 static $clinit() {
