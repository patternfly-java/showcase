...
/**
 * @extends {SubComponent<HTMLDivElement, CodeEditorTab>}
 */
class CodeEditorTab extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 /** @nodts @return {CodeEditorTab} */
 static m_codeEditorTab__org_patternfly_layout_PredefinedIcon__java_lang_String__org_patternfly_component_code_CodeEditorTab(/** PredefinedIcon */ icon, /** ?string */ text) {
  CodeEditorTab.$clinit();
  return CodeEditorTab.$create__().m_addIcon__org_patternfly_component_code_CodeEditorTabIcon__org_patternfly_component_code_CodeEditorTab(CodeEditorTabIcon.m_codeEditorTabIcon__org_patternfly_layout_PredefinedIcon__org_patternfly_component_code_CodeEditorTabIcon(icon)).m_addText__org_patternfly_component_code_CodeEditorTabText__org_patternfly_component_code_CodeEditorTab(CodeEditorTabText.m_codeEditorTabText__java_lang_String__org_patternfly_component_code_CodeEditorTabText(text));
 }
 /** @nodts @return {CodeEditorTab} */
 static m_codeEditorTab__java_lang_String__java_lang_String__org_patternfly_component_code_CodeEditorTab(/** ?string */ iconClass, /** ?string */ text) {
  CodeEditorTab.$clinit();
  return CodeEditorTab.$create__().m_addIcon__org_patternfly_component_code_CodeEditorTabIcon__org_patternfly_component_code_CodeEditorTab(CodeEditorTabIcon.m_codeEditorTabIcon__java_lang_String__org_patternfly_component_code_CodeEditorTabIcon(iconClass)).m_addText__org_patternfly_component_code_CodeEditorTabText__org_patternfly_component_code_CodeEditorTab(CodeEditorTabText.m_codeEditorTabText__java_lang_String__org_patternfly_component_code_CodeEditorTabText(text));
 }
 /** @nodts @return {!CodeEditorTab} */
 static $create__() {
  CodeEditorTab.$clinit();
