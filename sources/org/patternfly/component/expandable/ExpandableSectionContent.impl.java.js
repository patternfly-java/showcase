...
/**
 * @extends {SubComponent<HTMLDivElement, ExpandableSectionContent>}
 */
class ExpandableSectionContent extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {?string} @nodts*/
