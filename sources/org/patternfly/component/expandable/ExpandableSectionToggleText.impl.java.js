...
/**
 * @extends {SubComponent<HTMLElement, ExpandableSectionToggleText>}
 */
class ExpandableSectionToggleText extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
  /**@type {?string} @nodts*/
