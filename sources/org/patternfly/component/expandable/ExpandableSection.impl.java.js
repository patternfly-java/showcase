...
class ExpandableSection extends BaseComponent {
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (!$Equality.$same(this.f_toggle__org_patternfly_component_expandable_ExpandableSection_, null)) {
   this.f_toggle__org_patternfly_component_expandable_ExpandableSection_.m_passComponent__org_patternfly_component_expandable_ExpandableSection__void(this);
  }
 ...
 m_indented__boolean__org_patternfly_component_expandable_ExpandableSection(/** boolean */ indented) {
  if (indented) {
   /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.add(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_indented__org_patternfly_layout_Classes));
  } else {
   /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.remove(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_indented__org_patternfly_layout_Classes));
  }
  return this;
 }
 /** @nodts @return {ExpandableSection} */
 ...
 m_disclosure__boolean__org_patternfly_component_expandable_ExpandableSection(/** boolean */ disclosure) {
  if (disclosure) {
   /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.add(Classes.m_modifier__java_lang_String__org_patternfly_layout_Size__java_lang_String(Classes.f_display__org_patternfly_layout_Classes, Size.f_lg__org_patternfly_layout_Size), Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_limitWidth__org_patternfly_layout_Classes));
  } else {
   /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.remove(Classes.m_modifier__java_lang_String__org_patternfly_layout_Size__java_lang_String(Classes.f_display__org_patternfly_layout_Classes, Size.f_lg__org_patternfly_layout_Size), Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_limitWidth__org_patternfly_layout_Classes));
  }
  return this;
 }
 /** @nodts @return {ExpandableSection} */
 ...
 m_truncate__int__org_patternfly_component_expandable_ExpandableSection(/** number */ truncate) {
  if (truncate > 0) {
   ...
   /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.add(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_truncate__org_patternfly_layout_Classes));
  }
  return this;
 }
 /** @nodts @return {ExpandableSection} */
 m_detachedFrom__java_lang_String__org_patternfly_component_expandable_ExpandableSection(/** ?string */ detachedFromId) {
  ...
  this.m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_detached__org_patternfly_layout_Classes)], j_l_String)));
 ...
 m_collapse__boolean__void(/** boolean */ fireEvent) {
  /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.remove(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_expanded__org_patternfly_layout_Classes));
  if (!$Equality.$same(this.f_toggle__org_patternfly_component_expandable_ExpandableSection_, null)) {
  ...
  if (fireEvent && !$Equality.$same(this.f_toggleHandler__org_patternfly_component_expandable_ExpandableSection_, null)) {
   this.f_toggleHandler__org_patternfly_component_expandable_ExpandableSection_.m_onToggle__java_lang_Object__boolean__void(this, false);
  }
 }
 /** @override @nodts */
 m_expand__boolean__void(/** boolean */ fireEvent) {
  /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)).classList.add(Classes.m_modifier__java_lang_String__java_lang_String(Classes.f_expanded__org_patternfly_layout_Classes));
  if (!$Equality.$same(this.f_toggle__org_patternfly_component_expandable_ExpandableSection_, null)) {
  ...
  if (fireEvent && !$Equality.$same(this.f_toggleHandler__org_patternfly_component_expandable_ExpandableSection_, null)) {
   this.f_toggleHandler__org_patternfly_component_expandable_ExpandableSection_.m_onToggle__java_lang_Object__boolean__void(this, true);
  }
 }
