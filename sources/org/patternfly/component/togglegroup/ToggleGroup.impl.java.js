...
class ToggleGroup extends BaseComponent {
 ...
 static m_toggleGroup__org_patternfly_core_SelectionMode__org_patternfly_component_togglegroup_ToggleGroup(/** SelectionMode */ selectionMode) {
  ToggleGroup.$clinit();
  return ToggleGroup.$create__org_patternfly_core_SelectionMode(selectionMode);
 }
 /** @nodts @return {!ToggleGroup} */
 static $create__org_patternfly_core_SelectionMode(/** SelectionMode */ selectionMode) {
  ToggleGroup.$clinit();
  let $instance = new ToggleGroup();
  $instance.$ctor__org_patternfly_component_togglegroup_ToggleGroup__org_patternfly_core_SelectionMode__void(selectionMode);
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_togglegroup_ToggleGroup__org_patternfly_core_SelectionMode__void(/** SelectionMode */ selectionMode) {
  ...
  if ($Equality.$same(selectionMode, SelectionMode.f_click__org_patternfly_core_SelectionMode)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Selection mode \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(SelectionMode.f_click__org_patternfly_core_SelectionMode.name()) + '\' is not supported. Fall back to \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(SelectionMode.f_single__org_patternfly_core_SelectionMode.name()) + '\'');
   this.f_selectionMode__org_patternfly_component_togglegroup_ToggleGroup = SelectionMode.f_single__org_patternfly_core_SelectionMode;
  } else {
 ...
 m_select__org_patternfly_component_togglegroup_ToggleGroupItem__boolean__boolean__void(/** ToggleGroupItem */ item, /** boolean */ selected, /** boolean */ fireEvent) {
  if (!$Equality.$same(item, null)) {
   if ($Equality.$same(this.f_selectionMode__org_patternfly_component_togglegroup_ToggleGroup, SelectionMode.f_single__org_patternfly_core_SelectionMode)) {
