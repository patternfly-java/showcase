...
class ToggleGroupItem extends ToggleGroupSubComponent {
 ...
 /** @nodts @return {ToggleGroupItem} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_togglegroup_ToggleGroupItem(/** InlineIcon */ icon) {
  ...
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_togglegroup_ToggleGroupItem().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {ToggleGroupItem} */
 ...
 m_onClick__elemental2_dom_Event__void_$pp_org_patternfly_component_togglegroup(/** Event */ event) {
  ...
  if ($Equality.$same(toggleGroup.f_selectionMode__org_patternfly_component_togglegroup_ToggleGroup, SelectionMode.f_single__org_patternfly_core_SelectionMode)) {
  ...
  } else if ($Equality.$same(toggleGroup.f_selectionMode__org_patternfly_component_togglegroup_ToggleGroup, SelectionMode.f_multi__org_patternfly_core_SelectionMode)) {
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {ToggleGroupItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), ToggleGroupItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {ToggleGroupItem} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {ToggleGroupItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), ToggleGroupItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {ToggleGroupItem} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_togglegroup_ToggleGroupItem(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {ToggleGroupItem} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {ToggleGroupItem} */
 m_icon__java_lang_String__org_patternfly_component_togglegroup_ToggleGroupItem(/** ?string */ arg0) {
  return /**@type {ToggleGroupItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), ToggleGroupItem));
 }
 //Default method forwarding stub.
 /** @nodts @return {ToggleGroupItem} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_togglegroup_ToggleGroupItem(/** PredefinedIcon */ arg0) {
  return /**@type {ToggleGroupItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), ToggleGroupItem));
 }
 /** @nodts */
 static $clinit() {
