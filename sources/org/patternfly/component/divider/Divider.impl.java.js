...
class Divider extends BaseComponentFlat {
 ...
 static m_divider__org_patternfly_component_divider_DividerType__org_patternfly_component_divider_Divider(/** DividerType */ type) {
  ...
  switch (type.ordinal()) {
   ...
   default: 
    Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Divider__org_patternfly_component_ComponentType, null, 'Unknown divider type ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(type) + '. Fallback to ' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(DividerType.f_div__org_patternfly_component_divider_DividerType.name()));
    return Divider.$create__java_lang_String__java_lang_Class('div', Class.$get($JavaScriptObject));
  }
 }
