...
class InputGroupText extends InputGroupSubComponent {
 ...
 /** @nodts @return {InputGroupText} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_inputgroup_InputGroupText(/** InlineIcon */ icon) {
  this.m_removeIcon__org_patternfly_component_inputgroup_InputGroupText();
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(icon);
  return this;
 }
 /** @nodts @return {InputGroupText} */
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_inputgroup_InputGroupText(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {InputGroupText} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {InputGroupText} */
 m_icon__java_lang_String__org_patternfly_component_inputgroup_InputGroupText(/** ?string */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 //Default method forwarding stub.
 /** @nodts @return {InputGroupText} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_inputgroup_InputGroupText(/** PredefinedIcon */ arg0) {
  return /**@type {InputGroupText}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), InputGroupText));
 }
 /** @nodts */
 static $clinit() {
