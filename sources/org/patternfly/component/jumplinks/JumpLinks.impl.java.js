...
class JumpLinks extends BaseComponentFlat {
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if (this.f_expandable__org_patternfly_component_jumplinks_JumpLinks_ && !this.f_vertical__org_patternfly_component_jumplinks_JumpLinks_) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Expandable is only supported for vertical jump links!');
  } else {
