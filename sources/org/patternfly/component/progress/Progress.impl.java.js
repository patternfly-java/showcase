...
class Progress extends BaseComponentFlat {
 ...
 m_status__org_patternfly_style_Status__org_patternfly_component_progress_Progress(/** Status */ status) {
  if (Validation.m_verifyEnum__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__java_lang_String__java_lang_Enum__java_lang_Enum__arrayOf_java_lang_Enum__boolean(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'status', status, Status.f_info__org_patternfly_style_Status, /**@type {!Array<Status>}*/ ($Arrays.$init([Status.f_danger__org_patternfly_style_Status, Status.f_success__org_patternfly_style_Status, Status.f_warning__org_patternfly_style_Status], Status)))) {
   ...
   switch (status.ordinal()) {
    case Status.$ordinal_danger__org_patternfly_style_Status: 
     this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress().appendChild(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(PredefinedIcon.f_timesCircle__org_patternfly_style_PredefinedIcon).m_element__elemental2_dom_HTMLElement());
     if (!$Equality.$same(this.f_helperText__org_patternfly_component_progress_Progress_, null)) {
      this.f_helperText__org_patternfly_component_progress_Progress_.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_error__org_patternfly_core_ValidationStatus);
     }
     break;
    case Status.$ordinal_warning__org_patternfly_style_Status: 
     this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_progress_Progress().appendChild(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(PredefinedIcon.f_exclamationTriangle__org_patternfly_style_PredefinedIcon).m_element__elemental2_dom_HTMLElement());
     if (!$Equality.$same(this.f_helperText__org_patternfly_component_progress_Progress_, null)) {
      this.f_helperText__org_patternfly_component_progress_Progress_.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_warning__org_patternfly_core_ValidationStatus);
     }
     break;
    case Status.$ordinal_success__org_patternfly_style_Status: 
     ...
     if (!$Equality.$same(this.f_helperText__org_patternfly_component_progress_Progress_, null)) {
      this.f_helperText__org_patternfly_component_progress_Progress_.m_firstItem__org_patternfly_component_help_HelperTextItem().m_status__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperTextItem(ValidationStatus.f_success__org_patternfly_core_ValidationStatus);
     }
     break;
