...
class Menu extends BaseComponent {
 ...
 static m_menu__org_patternfly_component_menu_Menu() {
  Menu.$clinit();
  return Menu.$create__org_patternfly_component_menu_MenuType__org_patternfly_core_SelectionMode(MenuType.f_menu__org_patternfly_component_menu_MenuType, SelectionMode.f_click__org_patternfly_core_SelectionMode);
 }
 /** @nodts @return {Menu} */
 static m_menu__org_patternfly_core_SelectionMode__org_patternfly_component_menu_Menu(/** SelectionMode */ selectionMode) {
  Menu.$clinit();
  return Menu.$create__org_patternfly_component_menu_MenuType__org_patternfly_core_SelectionMode(MenuType.f_menu__org_patternfly_component_menu_MenuType, selectionMode);
 }
 /** @nodts @return {!Menu} */
 static $create__org_patternfly_component_menu_MenuType__org_patternfly_core_SelectionMode(/** MenuType */ menuType, /** SelectionMode */ selectionMode) {
  Menu.$clinit();
  let $instance = new Menu();
  $instance.$ctor__org_patternfly_component_menu_Menu__org_patternfly_component_menu_MenuType__org_patternfly_core_SelectionMode__void(menuType, selectionMode);
  return $instance;
 }
 /** @nodts */
 ...
 m_select__org_patternfly_component_menu_MenuItem__boolean__boolean__void(/** MenuItem */ item, /** boolean */ selected, /** boolean */ fireEvent) {
  if (!$Equality.$same(item, null)) {
   if ($Equality.$same(this.f_selectionMode__org_patternfly_component_menu_Menu, SelectionMode.f_click__org_patternfly_core_SelectionMode) || $Equality.$same(this.f_selectionMode__org_patternfly_component_menu_Menu, SelectionMode.f_single__org_patternfly_core_SelectionMode)) {
   ...
   switch (this.f_selectionMode__org_patternfly_component_menu_Menu.ordinal()) {
    case SelectionMode.$ordinal_click__org_patternfly_core_SelectionMode: 
     item.m_makeCurrent__boolean__void_$pp_org_patternfly_component_menu(selected);
     break;
    case SelectionMode.$ordinal_single__org_patternfly_core_SelectionMode: 
    case SelectionMode.$ordinal_multi__org_patternfly_core_SelectionMode: 
