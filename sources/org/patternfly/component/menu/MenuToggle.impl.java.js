...
class MenuToggle extends BaseComponent {
 ...
 /** @nodts @return {MenuToggle} */
 static m_menuToggle__org_patternfly_style_PredefinedIcon__org_patternfly_component_menu_MenuToggle(/** PredefinedIcon */ icon) {
  MenuToggle.$clinit();
  return /**@type {MenuToggle}*/ ($Casts.$to(MenuToggle.m_menuToggle__org_patternfly_component_menu_MenuToggleType__org_patternfly_component_menu_MenuToggle(MenuToggleType.f_plain__org_patternfly_component_menu_MenuToggleType).m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(icon), MenuToggle));
 }
 /** @nodts @return {MenuToggle} */
 static m_menuToggle__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_component_menu_MenuToggle(/** PredefinedIcon */ icon, /** ?string */ label) {
  MenuToggle.$clinit();
 ...
 static m_menuToggle__org_patternfly_component_icon_InlineIcon__org_patternfly_component_menu_MenuToggle(/** InlineIcon */ icon) {
  MenuToggle.$clinit();
  return MenuToggle.m_menuToggle__org_patternfly_component_menu_MenuToggleType__org_patternfly_component_menu_MenuToggle(MenuToggleType.f_plain__org_patternfly_component_menu_MenuToggleType).m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_menu_MenuToggle(icon);
 }
 /** @nodts @return {MenuToggle} */
 ...
 $ctor__org_patternfly_component_menu_MenuToggle__org_jboss_elemento_HTMLContainerBuilder__org_patternfly_component_menu_MenuToggleType__void(/** HTMLContainerBuilder<E> */ builder, /** MenuToggleType */ type) {
  ...
  if ($Equality.$same(type, MenuToggleType.f_plain__org_patternfly_component_menu_MenuToggleType)) {
   ...
   Logger.m_unknown__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Unknown menu toggle type \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(type.name()) + '\'');
  }
 }
 /** @nodts @return {MenuToggle} */
 ...
 m_add__org_patternfly_component_avatar_Avatar__org_patternfly_component_menu_MenuToggle(/** Avatar */ avatar) {
  if ($Equality.$same(this.f_type__org_patternfly_component_menu_MenuToggle_, MenuToggleType.f_default___org_patternfly_component_menu_MenuToggleType) || $Equality.$same(this.f_type__org_patternfly_component_menu_MenuToggle_, MenuToggleType.f_plainText__org_patternfly_component_menu_MenuToggleType)) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Avatar is not supported for menu toggles with type \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_type__org_patternfly_component_menu_MenuToggle_.name()) + '\'');
  }
  return this;
 }
 /** @nodts @return {MenuToggle} */
 ...
 m_add__org_patternfly_component_badge_Badge__org_patternfly_component_menu_MenuToggle(/** Badge */ badge) {
  if ($Equality.$same(this.f_type__org_patternfly_component_menu_MenuToggle_, MenuToggleType.f_default___org_patternfly_component_menu_MenuToggleType) || $Equality.$same(this.f_type__org_patternfly_component_menu_MenuToggle_, MenuToggleType.f_plainText__org_patternfly_component_menu_MenuToggleType)) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Badge is not supported for menu toggles with type \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_type__org_patternfly_component_menu_MenuToggle_.name()) + '\'');
  }
  return this;
 }
 /** @nodts @return {MenuToggle} */
 ...
 /** @nodts @return {MenuToggle} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_menu_MenuToggle(/** InlineIcon */ icon) {
  ...
  if ($Equality.$same(this.f_type__org_patternfly_component_menu_MenuToggle_, MenuToggleType.f_plain__org_patternfly_component_menu_MenuToggleType)) {
   ...
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Icon is not supported for menu toggles with type \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(this.f_type__org_patternfly_component_menu_MenuToggle_.name()) + '\'');
  }
  return this;
 }
 /** @nodts @return {MenuToggle} */
 m_removeIcon__org_patternfly_component_menu_MenuToggle() {
  Elements.m_failSafeRemoveFromParent__org_jboss_elemento_IsElement__boolean(this.f_icon__org_patternfly_component_menu_MenuToggle_);
 ...
 /** @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_core_IconPosition__org_patternfly_component_menu_MenuToggle(/** InlineIcon */ icon, /** ?string */ text, /** IconPosition */ iconPosition) {
  this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_menu_MenuToggle(icon);
 ...
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_menu_MenuToggle(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 ...
 m_iconAndText__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_iconAndText__java_lang_String__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__java_lang_String__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2), MenuToggle));
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return this.m_iconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_core_IconPosition__org_patternfly_component_menu_MenuToggle(arg0, arg1, arg2);
 }
 //Bridge method.
 /** @final @override @nodts @return {MenuToggle} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_menu_MenuToggle(/** PredefinedIcon */ arg0) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_iconAndText__java_lang_String__java_lang_String__org_patternfly_component_menu_MenuToggle(/** ?string */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_component_menu_MenuToggle(/** PredefinedIcon */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_component_menu_MenuToggle(/** InlineIcon */ arg0, /** ?string */ arg1) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_component_icon_InlineIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_iconAndText__java_lang_String__java_lang_String__org_patternfly_core_IconPosition__org_patternfly_component_menu_MenuToggle(/** ?string */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__java_lang_String__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
 m_iconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_core_IconPosition__org_patternfly_component_menu_MenuToggle(/** PredefinedIcon */ arg0, /** ?string */ arg1, /** IconPosition */ arg2) {
  return /**@type {MenuToggle}*/ ($Casts.$to(WithIconAndText.m_iconAndText__$default__org_patternfly_core_WithIconAndText__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_core_IconPosition__org_jboss_elemento_TypedBuilder(this, arg0, arg1, arg2), MenuToggle));
 }
 //Default method forwarding stub.
 /** @nodts @return {MenuToggle} */
