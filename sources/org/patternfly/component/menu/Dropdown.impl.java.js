...
class Dropdown extends ComponentDelegate {
 ...
 $ctor__org_patternfly_component_menu_Dropdown__void() {
  ...
  this.f_triggerActions__org_patternfly_component_menu_Dropdown_ = /**@type {EnumSet<TriggerAction>}*/ (EnumSet.m_of__java_lang_Enum__java_util_EnumSet(TriggerAction.f_click__org_patternfly_thirdparty_popper_TriggerAction));
  this.f_flip__org_patternfly_component_menu_Dropdown_ = true;
  this.f_placement__org_patternfly_component_menu_Dropdown_ = Placement.f_bottomStart__org_patternfly_thirdparty_popper_Placement;
 ...
 /** @nodts @return {Dropdown} */
 m_placement__org_patternfly_thirdparty_popper_Placement__org_patternfly_component_menu_Dropdown(/** Placement */ placement) {
