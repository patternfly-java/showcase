goog.module('org.patternfly.component.BaseComponentSVG$impl');
 ...
 * @implements {HasSVGElement<E, B>}
 * @implements {Finder<E>}
 * @implements {Container<E, B>}
 */
class BaseComponentSVG extends j_l_Object {
 /** @protected @nodts */
 constructor() {
  super();
 ...
 m_data__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0, /** ?string */ arg1) {
  return HasSVGElement.m_data__$default__org_jboss_elemento_svg_HasSVGElement__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0, arg1);
 }
 //Default method forwarding stub.
 /** @override @nodts @return {B} */
 ...
 static $isInstance(/** ? */ instance) {
  return instance instanceof BaseComponentSVG;
 }
...
Component.$markImplementor(BaseComponentSVG);
HasElement.$markImplementor(BaseComponentSVG);
HasSVGElement.$markImplementor(BaseComponentSVG);
Finder.$markImplementor(BaseComponentSVG);
Container.$markImplementor(BaseComponentSVG);
$Util.$setClassMetadata(BaseComponentSVG, 'org.patternfly.component.BaseComponentSVG');

exports = BaseComponentSVG;

//# sourceMappingURL=BaseComponentSVG.js.map
