...
/**
 * @extends {SubComponent<HTMLDivElement, CardBody>}
 * @implements {NoFill<HTMLDivElement, CardBody>}
 */
class CardBody extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 m_noFill__org_jboss_elemento_TypedBuilder() {
  return /**@type {CardBody}*/ ($Casts.$to(NoFill.m_noFill__$default__org_patternfly_core_Modifiers_NoFill__org_jboss_elemento_TypedBuilder(this), CardBody));
 }
 //Bridge method.
 /** @final @override @nodts @return {CardBody} */
 m_noFill__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {CardBody}*/ ($Casts.$to(NoFill.m_noFill__$default__org_patternfly_core_Modifiers_NoFill__boolean__org_jboss_elemento_TypedBuilder(this, arg0), CardBody));
 }
