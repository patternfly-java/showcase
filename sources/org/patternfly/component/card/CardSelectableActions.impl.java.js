  ...
  if (card.m_isClickable__boolean_$pp_org_patternfly_component_card() && !card.m_isSelectable__boolean_$pp_org_patternfly_component_card()) {
   ...
   if ($Equality.$same(card.f_selectionMode__org_patternfly_component_card_Card, SelectionMode.f_single__org_patternfly_core_SelectionMode)) {
    ...
    if ($Equality.$same(radioName_1, null)) {
     ...
     Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Card__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to(card.m_element__elemental2_dom_HTMLElement(), $Overlay)), 'Name is undefined for single selectable card \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(cardId_1) + '\'.\n' + 'You must provide a common name for all single selectable cards using \'Card.name(String)\'.\n' + 'Fallback to generated name \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(radioName_1) + '\', which will cause selection issues!');
    }
    ...
    if ($Equality.$same(checkboxName, null)) {
     ...
     Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_Card__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to(card.m_element__elemental2_dom_HTMLElement(), $Overlay)), 'Name is undefined for multi-select card \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(cardId_1) + '\'.\n' + 'You must provide a common name for all selectable cards using \'Card.name(String)\'.\n' + 'Fallback to generated name \'' + j_l_String.m_valueOf__java_lang_Object__java_lang_String(checkboxName) + '\', which will cause selection issues!');
    }
