...
/**
 * @extends {SubComponent<HTMLDivElement, CardExpandableContent>}
 * @implements {NoFill<HTMLDivElement, CardExpandableContent>}
 */
class CardExpandableContent extends SubComponent {
 /** @protected @nodts */
 constructor() {
  super();
 }
 ...
 m_addBody__org_patternfly_component_card_CardBody__org_patternfly_component_card_CardExpandableContent(/** CardBody */ body) {
  return this.m_add__org_patternfly_component_card_CardBody__org_patternfly_component_card_CardExpandableContent(body);
 }
 /** @nodts @return {CardExpandableContent} */
 m_add__org_patternfly_component_card_CardBody__org_patternfly_component_card_CardExpandableContent(/** CardBody */ body) {
  return /**@type {CardExpandableContent}*/ ($Casts.$to(this.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(/**@type {HTMLDivElement}*/ ($Casts.$to(body.m_element__elemental2_dom_HTMLElement(), $Overlay))), CardExpandableContent));
 }
 /** @nodts @return {CardExpandableContent} */
 m_addFooter__org_patternfly_component_card_CardFooter__org_patternfly_component_card_CardExpandableContent(/** CardFooter */ footer) {
  return this.m_add__org_patternfly_component_card_CardFooter__org_patternfly_component_card_CardExpandableContent(footer);
 }
 /** @nodts @return {CardExpandableContent} */
 m_add__org_patternfly_component_card_CardFooter__org_patternfly_component_card_CardExpandableContent(/** CardFooter */ footer) {
  return /**@type {CardExpandableContent}*/ ($Casts.$to(this.m_add__elemental2_dom_Node__org_jboss_elemento_TypedBuilder(/**@type {HTMLDivElement}*/ ($Casts.$to(footer.m_element__elemental2_dom_HTMLElement(), $Overlay))), CardExpandableContent));
 }
 /** @nodts @return {CardExpandableContent} */
 ...
 m_noFill__org_jboss_elemento_TypedBuilder() {
  return /**@type {CardExpandableContent}*/ ($Casts.$to(NoFill.m_noFill__$default__org_patternfly_core_Modifiers_NoFill__org_jboss_elemento_TypedBuilder(this), CardExpandableContent));
 }
 //Bridge method.
 /** @final @override @nodts @return {CardExpandableContent} */
 m_noFill__boolean__org_jboss_elemento_TypedBuilder(/** boolean */ arg0) {
  return /**@type {CardExpandableContent}*/ ($Casts.$to(NoFill.m_noFill__$default__org_patternfly_core_Modifiers_NoFill__boolean__org_jboss_elemento_TypedBuilder(this, arg0), CardExpandableContent));
 }
