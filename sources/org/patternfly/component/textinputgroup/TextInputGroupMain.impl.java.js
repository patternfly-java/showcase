...
class TextInputGroupMain extends TextInputGroupSubComponent {
 ...
 /** @nodts @return {TextInputGroupMain} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_textinputgroup_TextInputGroupMain(/** InlineIcon */ icon) {
  ...
  this.f_iconContainer__org_patternfly_component_textinputgroup_TextInputGroupMain_.appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {TextInputGroupMain} */
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {TextInputGroupMain}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), TextInputGroupMain));
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInputGroupMain} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {TextInputGroupMain}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), TextInputGroupMain));
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInputGroupMain} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_textinputgroup_TextInputGroupMain(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {TextInputGroupMain} */
 ...
 //Default method forwarding stub.
 /** @nodts @return {TextInputGroupMain} */
 m_icon__java_lang_String__org_patternfly_component_textinputgroup_TextInputGroupMain(/** ?string */ arg0) {
  return /**@type {TextInputGroupMain}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), TextInputGroupMain));
 }
 //Default method forwarding stub.
 /** @nodts @return {TextInputGroupMain} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_textinputgroup_TextInputGroupMain(/** PredefinedIcon */ arg0) {
  return /**@type {TextInputGroupMain}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), TextInputGroupMain));
 }
 /** @nodts */
 static $clinit() {
