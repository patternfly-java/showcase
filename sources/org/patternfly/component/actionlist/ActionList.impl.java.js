goog.module('org.patternfly.component.actionlist.ActionList$impl');
...
class ActionList extends BaseComponent {
 ...
 static m_actionList__org_patternfly_component_actionlist_ActionList() {
  ActionList.$clinit();
 ...
 static $create__() {
  ...
  $instance.$ctor__org_patternfly_component_actionlist_ActionList__void();
  return $instance;
 }
 /** @nodts */
 ...
 /** @nodts @return {ActionList} */
 m_addItem__org_patternfly_component_actionlist_ActionListItem__org_patternfly_component_actionlist_ActionList(/** ActionListItem */ item) {
 ...
 m_that__org_jboss_elemento_TypedBuilder() {
  return this.m_that__org_patternfly_component_actionlist_ActionList();
 }
 /** @nodts */
 static $clinit() {
  ActionList.$clinit = () =>{};
...
$Util.$setClassMetadata(ActionList, 'org.patternfly.component.actionlist.ActionList');
