...
class HelperText extends BaseComponentFlat {
 ...
 /** @nodts @return {HelperText} */
 static m_helperText__java_lang_String__org_patternfly_core_ValidationStatus__org_patternfly_component_help_HelperText(/** ?string */ text, /** ValidationStatus */ status) {
  HelperText.$clinit();
 ...
 m_firstItem__org_patternfly_component_help_HelperTextItem() {
  if ($Equality.$same(this.f_firstItem__org_patternfly_component_help_HelperText_, null)) {
   Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'Helper text does not contain any items. Returning empty item instead');
