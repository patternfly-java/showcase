...
class Alert extends BaseComponent {
 ...
 /** @nodts @return {Alert} */
 static m_alert__org_patternfly_core_Severity__java_lang_String__org_patternfly_component_alert_Alert(/** Severity */ type, /** ?string */ title) {
  Alert.$clinit();
  return Alert.$create__org_patternfly_core_Severity__java_lang_String(type, title);
 }
 /** @nodts @return {!Alert} */
 static $create__org_patternfly_core_Severity__java_lang_String(/** Severity */ severity, /** ?string */ title) {
  Alert.$clinit();
  let $instance = new Alert();
  $instance.$ctor__org_patternfly_component_alert_Alert__org_patternfly_core_Severity__java_lang_String__void(severity, title);
  return $instance;
 }
 /** @nodts */
