...
class EmptyStateHeader extends EmptyStateSubComponent {
 ...
 $ctor__org_patternfly_component_emptystate_EmptyStateHeader__int__void(/** number */ headingLevel) {
  ...
  if (Validation.m_verifyRange__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean(ComponentType.f_EmptyState__org_patternfly_component_ComponentType, /**@type {HTMLDivElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLDivElement_$Overlay)), 'headingLevel', headingLevel, 1, 6)) {
 ...
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_emptystate_EmptyStateHeader(/** InlineIcon */ icon) {
  this.m_removeIcon__org_patternfly_component_emptystate_EmptyStateHeader();
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_emptystate_EmptyStateHeader().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {EmptyStateHeader} */
 m_icon__java_lang_String__org_patternfly_style_Variable__org_patternfly_component_emptystate_EmptyStateHeader(/** ?string */ iconClass, /** Variable */ color) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_style_Variable__org_patternfly_component_emptystate_EmptyStateHeader(InlineIcon.m_inlineIcon__java_lang_String__org_patternfly_component_icon_InlineIcon(iconClass), color);
 }
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_style_Variable__org_patternfly_component_emptystate_EmptyStateHeader(/** PredefinedIcon */ predefinedIcon, /** Variable */ color) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_style_Variable__org_patternfly_component_emptystate_EmptyStateHeader(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(predefinedIcon), color);
 }
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_style_Variable__org_patternfly_component_emptystate_EmptyStateHeader(/** InlineIcon */ icon, /** Variable */ color) {
  this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_emptystate_EmptyStateHeader(icon);
 ...
 /** @nodts @return {EmptyStateHeader} */
 m_icon__java_lang_String__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(/** ?string */ iconClass, /** ?string */ color) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(InlineIcon.m_inlineIcon__java_lang_String__org_patternfly_component_icon_InlineIcon(iconClass), color);
 }
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_style_PredefinedIcon__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(/** PredefinedIcon */ predefinedIcon, /** ?string */ color) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(InlineIcon.m_inlineIcon__org_patternfly_style_PredefinedIcon__org_patternfly_component_icon_InlineIcon(predefinedIcon), color);
 }
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_component_icon_InlineIcon__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(/** InlineIcon */ icon, /** ?string */ color) {
  this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_emptystate_EmptyStateHeader(icon);
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {EmptyStateHeader}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateHeader));
 }
 //Bridge method.
 /** @final @override @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {EmptyStateHeader}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateHeader));
 }
 //Bridge method.
 /** @final @override @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_emptystate_EmptyStateHeader(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {EmptyStateHeader} */
 ...
 /** @nodts @return {EmptyStateHeader} */
 m_icon__java_lang_String__org_patternfly_component_emptystate_EmptyStateHeader(/** ?string */ arg0) {
  return /**@type {EmptyStateHeader}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateHeader));
 }
 //Default method forwarding stub.
 /** @nodts @return {EmptyStateHeader} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_emptystate_EmptyStateHeader(/** PredefinedIcon */ arg0) {
  return /**@type {EmptyStateHeader}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), EmptyStateHeader));
 }
 /** @nodts */
 static $clinit() {
