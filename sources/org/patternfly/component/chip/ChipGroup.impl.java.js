...
class ChipGroup extends BaseComponent {
 ...
 $ctor__org_patternfly_component_chip_ChipGroup__java_lang_String__void(/** ?string */ category) {
  ...
  if (!$Equality.$same(category, null)) {
   ...
   this.m_aria__java_lang_String__java_lang_String__org_patternfly_component_chip_ChipGroup(Classes.f_label__org_patternfly_layout_Classes, 'Chip group category');
  }
 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  for (let $iterator = this.f_chips__org_patternfly_component_chip_ChipGroup_.values().m_iterator__java_util_Iterator(); $iterator.m_hasNext__boolean(); ) {
   ...
   {
    chip.m_passComponent__org_patternfly_component_chip_ChipGroup__void(this);
   }
  }
 }
 ...
 m_closable__org_patternfly_handler_CloseHandler__org_patternfly_component_chip_ChipGroup(/** CloseHandler<ChipGroup> */ closeHandler) {
  ...
  this.m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(/**@type {HTMLContainerBuilder<HTMLDivElement>}*/ ($Casts.$to(Elements.m_div__org_jboss_elemento_HTMLContainerBuilder().m_css__arrayOf_java_lang_String__org_jboss_elemento_TypedBuilder(/**@type {!Array<?string>}*/ ($Arrays.$init([Classes.m_component__java_lang_String__arrayOf_java_lang_String__java_lang_String(Classes.f_chipGroup__org_patternfly_layout_Classes, /**@type {!Array<?string>}*/ ($Arrays.$init([Classes.f_close__org_patternfly_layout_Classes], j_l_String)))], j_l_String))), HTMLContainerBuilder)).m_add__org_jboss_elemento_IsElement__org_jboss_elemento_TypedBuilder(this.f_closeButton__org_patternfly_component_chip_ChipGroup_ = /**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(/**@type {Button}*/ ($Casts.$to(Button.m_button__org_patternfly_layout_PredefinedIcon__java_lang_String__org_patternfly_component_button_Button(PredefinedIcon.f_timesCircle__org_patternfly_layout_PredefinedIcon, 'Close chip group').m_plain__org_jboss_elemento_TypedBuilder(), Button)).m_id__java_lang_String__org_jboss_elemento_TypedBuilder(closeId), Button)).m_aria__java_lang_String__java_lang_String__org_jboss_elemento_TypedBuilder(Classes.f_labelledBy__org_patternfly_layout_Classes, labelledBy), Button)).m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn__org_jboss_elemento_TypedBuilder(EventType.f_click__org_jboss_elemento_EventType, (event) =>{
