goog.module('org.patternfly.component.descriptionlist.DescriptionList$impl');
...
let DescriptionListGroup = goog.forwardDeclare('org.patternfly.component.descriptionlist.DescriptionListGroup$impl');
...
class DescriptionList extends BaseComponent {
 ...
 static m_descriptionList__org_patternfly_component_descriptionlist_DescriptionList() {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_patternfly_component_descriptionlist_DescriptionList__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_descriptionlist_DescriptionList__void() {
 ...
 /** @nodts @return {DescriptionList} */
 m_addGroup__org_patternfly_component_descriptionlist_DescriptionListGroup__org_patternfly_component_descriptionlist_DescriptionList(/** DescriptionListGroup */ group) {
 ...
 /** @nodts @return {DescriptionList} */
 m_autoColumnWidths__org_patternfly_component_descriptionlist_DescriptionList() {
  return this.m_autoColumnWidths__boolean__org_patternfly_component_descriptionlist_DescriptionList(true);
 }
 /** @nodts @return {DescriptionList} */
 m_autoColumnWidths__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ autoColumnWidths) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this.m_that__org_patternfly_component_descriptionlist_DescriptionList(), this.m_element__elemental2_dom_HTMLElement(), Classes.f_autoColumnWidths__org_patternfly_style_Classes, autoColumnWidths), DescriptionList));
 }
 /** @nodts @return {DescriptionList} */
 m_autoFit__org_patternfly_component_descriptionlist_DescriptionList() {
  return this.m_autoFit__boolean__org_patternfly_component_descriptionlist_DescriptionList(true);
 }
 /** @nodts @return {DescriptionList} */
 m_autoFit__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ autoFit) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this.m_that__org_patternfly_component_descriptionlist_DescriptionList(), this.m_element__elemental2_dom_HTMLElement(), Classes.f_autoFit__org_patternfly_style_Classes, autoFit), DescriptionList));
 }
 /** @nodts @return {DescriptionList} */
 m_autoFitMin__org_patternfly_style_Breakpoints__org_patternfly_component_descriptionlist_DescriptionList(/** Breakpoints<?string> */ autoFitMin) {
 ...
 /** @nodts @return {DescriptionList} */
 m_columns__org_patternfly_style_Breakpoints__org_patternfly_component_descriptionlist_DescriptionList(/** Breakpoints<Integer> */ columns) {
  if (!$Equality.$same(columns, null)) {
   let modifiers = /**@type {?string}*/ ($Casts.$to(columns.m_stream__java_util_stream_Stream().m_filter__java_util_function_Predicate__java_util_stream_Stream(Predicate.$adapt((bp) =>{
    ...
    return Validation.m_verifyRange__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__java_lang_String__int__int__int__boolean(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'columns', /**@type {Integer}*/ ($Casts.$to(bp_1.f_value__org_patternfly_core_Tuple, Integer)).m_intValue__int(), 1, 3);
 ...
 /** @nodts @return {DescriptionList} */
 m_displaySize__org_patternfly_style_Size__org_patternfly_component_descriptionlist_DescriptionList(/** Size */ size) {
  if (Validation.m_verifyEnum__org_patternfly_component_ComponentType__elemental2_dom_HTMLElement__java_lang_String__java_lang_Enum__java_lang_Enum__arrayOf_java_lang_Enum__boolean(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'displaySize', size, Size.f_lg__org_patternfly_style_Size, /**@type {!Array<Size>}*/ ($Arrays.$init([Size.f__2xl__org_patternfly_style_Size], Size)))) {
 ...
 /** @nodts @return {DescriptionList} */
 m_fillColumns__org_patternfly_component_descriptionlist_DescriptionList() {
  return this.m_fillColumns__boolean__org_patternfly_component_descriptionlist_DescriptionList(true);
 }
 /** @nodts @return {DescriptionList} */
 m_fillColumns__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ fillColumns) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this.m_that__org_patternfly_component_descriptionlist_DescriptionList(), this.m_element__elemental2_dom_HTMLElement(), Classes.f_fillColumns__org_patternfly_style_Classes, fillColumns), DescriptionList));
 }
 /** @nodts @return {DescriptionList} */
 m_fluid__org_patternfly_component_descriptionlist_DescriptionList() {
  return this.m_fluid__boolean__org_patternfly_component_descriptionlist_DescriptionList(true);
 }
 /** @nodts @return {DescriptionList} */
 m_fluid__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ fluid) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this.m_that__org_patternfly_component_descriptionlist_DescriptionList(), this.m_element__elemental2_dom_HTMLElement(), Classes.f_fluid__org_patternfly_style_Classes, fluid), DescriptionList));
 }
 /** @nodts @return {DescriptionList} */
 m_horizontalTermWidth__org_patternfly_style_Breakpoints__org_patternfly_component_descriptionlist_DescriptionList(/** Breakpoints<?string> */ horizontalTermWidth) {
 ...
 /** @nodts @return {DescriptionList} */
 m_inlineGrid__org_patternfly_component_descriptionlist_DescriptionList() {
  return this.m_inlineGrid__boolean__org_patternfly_component_descriptionlist_DescriptionList(true);
 }
 /** @nodts @return {DescriptionList} */
 m_inlineGrid__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ inlineGrid) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Modifiers.m_toggleModifier__org_jboss_elemento_TypedBuilder__elemental2_dom_Element__java_lang_String__boolean__org_jboss_elemento_TypedBuilder(this.m_that__org_patternfly_component_descriptionlist_DescriptionList(), this.m_element__elemental2_dom_HTMLElement(), Classes.f_inlineGrid__org_patternfly_style_Classes, inlineGrid), DescriptionList));
 }
 /** @nodts @return {DescriptionList} */
 m_orientation__org_patternfly_style_Breakpoints__org_patternfly_component_descriptionlist_DescriptionList(/** Breakpoints<Orientation> */ orientation) {
 ...
 /** @nodts @return {DescriptionList} */
 m_termWidth__java_lang_String__org_patternfly_component_descriptionlist_DescriptionList(/** ?string */ width) {
 ...
 /** @nodts @return {DescriptionList} */
 m_that__org_patternfly_component_descriptionlist_DescriptionList() {
  return this;
 }
 //Bridge method.
 /** @final @override @nodts @return {DescriptionList} */
 m_that__org_jboss_elemento_TypedBuilder() {
  return this.m_that__org_patternfly_component_descriptionlist_DescriptionList();
 }
 //Bridge method.
 /** @final @override @nodts @return {DescriptionList} */
 ...
 /** @nodts @return {DescriptionList} */
 m_compact__org_patternfly_component_descriptionlist_DescriptionList() {
  return /**@type {DescriptionList}*/ ($Casts.$to(Compact.m_compact__$default__org_patternfly_style_Modifiers_Compact__org_jboss_elemento_TypedBuilder(this), DescriptionList));
 }
 //Default method forwarding stub.
 /** @nodts @return {DescriptionList} */
 m_compact__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ arg0) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Compact.m_compact__$default__org_patternfly_style_Modifiers_Compact__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DescriptionList));
 }
 //Default method forwarding stub.
 /** @nodts @return {DescriptionList} */
 m_horizontal__org_patternfly_component_descriptionlist_DescriptionList() {
  return /**@type {DescriptionList}*/ ($Casts.$to(Horizontal.m_horizontal__$default__org_patternfly_style_Modifiers_Horizontal__org_jboss_elemento_TypedBuilder(this), DescriptionList));
 }
 //Default method forwarding stub.
 /** @nodts @return {DescriptionList} */
 m_horizontal__boolean__org_patternfly_component_descriptionlist_DescriptionList(/** boolean */ arg0) {
  return /**@type {DescriptionList}*/ ($Casts.$to(Horizontal.m_horizontal__$default__org_patternfly_style_Modifiers_Horizontal__boolean__org_jboss_elemento_TypedBuilder(this, arg0), DescriptionList));
 }
 /** @nodts */
 static $clinit() {
...
$Util.$setClassMetadata(DescriptionList, 'org.patternfly.component.descriptionlist.DescriptionList');
