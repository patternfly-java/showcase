...
class ListItem extends ListSubComponent {
 ...
 /** @nodts @return {ListItem} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_list_ListItem(/** InlineIcon */ icon) {
  ...
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_list_ListItem().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {ListItem} */
 ...
 m_icon__java_lang_String__org_jboss_elemento_TypedBuilder(/** ?string */ arg0) {
  return /**@type {ListItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), ListItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {ListItem} */
 m_icon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(/** PredefinedIcon */ arg0) {
  return /**@type {ListItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), ListItem));
 }
 //Bridge method.
 /** @final @override @nodts @return {ListItem} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_list_ListItem(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {ListItem} */
 ...
 /** @nodts @return {ListItem} */
 m_icon__java_lang_String__org_patternfly_component_list_ListItem(/** ?string */ arg0) {
  return /**@type {ListItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), ListItem));
 }
 //Default method forwarding stub.
 /** @nodts @return {ListItem} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_list_ListItem(/** PredefinedIcon */ arg0) {
  return /**@type {ListItem}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), ListItem));
 }
 /** @nodts */
 static $clinit() {
