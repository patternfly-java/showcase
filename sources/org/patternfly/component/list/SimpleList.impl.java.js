...
class SimpleList extends BaseComponent {
 ...
 m_add__org_patternfly_component_list_SimpleListGroup__org_patternfly_component_list_SimpleList(/** SimpleListGroup */ group) {
  if ($Equality.$same(this.f_type__org_patternfly_component_list_SimpleList_, SimpleListType.f_items__org_patternfly_component_list_SimpleListType)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'This simple list already contains items. A mix of groups and items is not supported!');
   return this;
  }
 ...
 m_add__org_patternfly_component_list_SimpleListItem__org_patternfly_component_list_SimpleList(/** SimpleListItem */ item) {
  if ($Equality.$same(this.f_type__org_patternfly_component_list_SimpleList_, SimpleListType.f_groups__org_patternfly_component_list_SimpleListType)) {
   Logger.m_unsupported__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), this.m_element__elemental2_dom_HTMLElement(), 'This simple list already contains groups. A mix of groups and items is not supported!');
   return this;
  }
