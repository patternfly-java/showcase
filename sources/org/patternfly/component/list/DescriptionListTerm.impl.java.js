...
class DescriptionListTerm extends DescriptionListSubComponent {
 ...
 /** @nodts @return {DescriptionListTerm} */
 m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_list_DescriptionListTerm(/** InlineIcon */ icon) {
  ...
  this.m_failSafeIconContainer__elemental2_dom_HTMLElement_$p_org_patternfly_component_list_DescriptionListTerm().appendChild(icon.m_element__elemental2_dom_HTMLElement());
  return this;
 }
 /** @nodts @return {DescriptionListTerm} */
 ...
 m_icon__org_patternfly_component_icon_InlineIcon__org_jboss_elemento_TypedBuilder(/** InlineIcon */ arg0) {
  return this.m_icon__org_patternfly_component_icon_InlineIcon__org_patternfly_component_list_DescriptionListTerm(arg0);
 }
 //Bridge method.
 /** @final @override @nodts @return {DescriptionListTerm} */
 ...
 /** @nodts @return {DescriptionListTerm} */
 m_icon__java_lang_String__org_patternfly_component_list_DescriptionListTerm(/** ?string */ arg0) {
  return /**@type {DescriptionListTerm}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__java_lang_String__org_jboss_elemento_TypedBuilder(this, arg0), DescriptionListTerm));
 }
 //Default method forwarding stub.
 /** @nodts @return {DescriptionListTerm} */
 m_icon__org_patternfly_style_PredefinedIcon__org_patternfly_component_list_DescriptionListTerm(/** PredefinedIcon */ arg0) {
  return /**@type {DescriptionListTerm}*/ ($Casts.$to(WithIcon.m_icon__$default__org_patternfly_core_WithIcon__org_patternfly_style_PredefinedIcon__org_jboss_elemento_TypedBuilder(this, arg0), DescriptionListTerm));
 }
 //Default method forwarding stub.
 /** @nodts @return {DescriptionListTerm} */
