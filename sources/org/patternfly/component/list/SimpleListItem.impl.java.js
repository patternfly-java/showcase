...
class SimpleListItem extends SimpleListSubComponent {
 ...
 m_target__java_lang_String__org_patternfly_component_list_SimpleListItem(/** ?string */ target) {
  if (!$Equality.$same(this.f_anchorElement__org_patternfly_component_list_SimpleListItem_, null)) {
   ...
   Logger.m_undefined__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(ComponentType.f_SimpleList__org_patternfly_component_ComponentType, /**@type {HTMLLIElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLLIElement_$Overlay)), 'Unable to set target: This simple list item is not an <a/> item.');
  }
  return this;
 }
 /** @nodts @return {SimpleListItem} */
