goog.module('org.patternfly.component.DataList.Item$impl');
...
/**
 * @extends {SubComponent<HTMLLIElement, Item>}
 * @deprecated
 */
class Item extends SubComponent {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_patternfly_component_DataList_Item__void();
  return $instance;
 }
 /** @nodts */
 $ctor__org_patternfly_component_DataList_Item__void() {
 ...
 /** @nodts @return {Item} */
 m_that__org_patternfly_component_DataList_Item() {
  return this;
 }
 //Bridge method.
 /** @final @override @nodts @return {Item} */
 m_that__org_jboss_elemento_TypedBuilder() {
  return this.m_that__org_patternfly_component_DataList_Item();
 }
 /** @nodts */
 static $clinit() {
  Item.$clinit = () =>{};
...
$Util.$setClassMetadata(Item, 'org.patternfly.component.DataList$Item');

exports = Item;

//# sourceMappingURL=DataList$Item.js.map
