 ...
 m_attach__elemental2_dom_MutationRecord__void(/** MutationRecord */ mutationRecord) {
  if ($Equality.$same(this.f_labelOnElement__org_patternfly_component_switch__Switch_, null)) {
   ...
   if ($Equality.$same(ariaLabel, null) || j_l_String.m_isEmpty__java_lang_String__boolean(ariaLabel)) {
    Logger.m_missing__org_patternfly_component_ComponentType__elemental2_dom_Element__java_lang_String__void(this.m_componentType__org_patternfly_component_ComponentType(), /**@type {HTMLLabelElement}*/ ($Casts.$to(this.m_element__elemental2_dom_HTMLElement(), HTMLLabelElement_$Overlay)), 'Switch requires either a label or an aria-label to be specified.');
   }
  }
 }
 /** @nodts @return {Switch} */
