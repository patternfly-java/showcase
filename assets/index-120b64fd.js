...
Alert danger3 = danger("Danger alert title");`,Tt=`import static org.patternfly.components.Alert.default_;
import static org.patternfly.components.Alert.description;
import static org.patternfly.components.Alert.info;
import static org.patternfly.components.AlertGroup.toast;
...
Alert default3 = default_("Default alert title");`,Ct=`import static org.patternfly.components.Alert.description;
import static org.patternfly.components.Alert.info;
import static org.patternfly.components.AlertGroup.toast;
...
Alert info3 = info("Info alert title");`,At=`Alert.custom("Custom alert title")
        .inline();
...
Alert.danger("danger alert title")
        .inline();`,Lt=`import static org.patternfly.components.Alert.description;
import static org.patternfly.components.Alert.info;
...
Alert inline3 = success("Success alert title").inline();`,Dt=`Alert inline0 = default_("Default inline alert title").inline();
...
Alert inline4 = danger("Danger inline alert title").inline();`,xt=`/*
...
Alert success2 = success("Success alert title")
        .action("Action Button", () -> toast().add(info("Success action button clicked.")));
Alert success3 = success("Success alert title");`,_t=`Alert.custom("Custom alert title");
Alert.info("Info alert title");
Alert.success("Success alert title");
Alert.warning("warning alert title");
Alert.danger("danger alert title");`,It=`Alert.success("Success alert title")
        .closable()
...
Alert warning3 = warning("Warning alert title");`,Nt=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
 ...
 *  limitations under the License.
 */
Avatar avatar = Avatar.avatar("./images/img_avatar.svg", "avatar");`,Rt=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
 ...
 *  limitations under the License.
 */
Brand brand = Brand.brand("https://www.patternfly.org/assets/images/pf_logo.svg");`,Ot=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
 ...
 *  limitations under the License.
 */
Button button = Button.button("Block level button").primary().block();`,Mt=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Button button = Button.button("Click me").primary()
        .onClick(() -> toast().add(info("Hello")));`,Bt=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Button b32 = Button.control("Control disabled").disable());`,zt=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Button b2 = Button.button("Default").type(Type.DEFAULT);`,Ft=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Button b14 = Button.control(icon(fas("code"));`,Ht=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
        ...
        .add(head()
                .add(actions()
                        .add(Dropdown.<String> kebab().right()
                                ...
                                .add("Separated Link"))
                        .add(input(checkbox))))
        .add(body().textContent("This is the card body, there is only actions in the card head."));`,Ut=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
...
Card card = card().style("min-height: 30em;")
        ...
        .add(footer().textContent("Footer"));`,Wt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;
import static org.patternfly.components.Card.header;
...
Card card = card().compact()
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,Kt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;

Card card = card()
        .add(body().textContent("Body"));`,Gt=`import static org.elemento.Elements.input;
import static org.elemento.InputType.checkbox;
import static org.patternfly.components.Card.Head.actions;
import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
...
Card card = card()
        ...
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,Yt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;
import static org.patternfly.components.Card.header;
...
Card card = card().hoverable()
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,Vt=`import static org.elemento.Elements.img;
import static org.elemento.Elements.input;
import static org.elemento.InputType.checkbox;
import static org.patternfly.components.Card.Head.actions;
import static org.patternfly.components.Card.body;
...
Card card = card()
        ...
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,qt=`import static org.elemento.Elements.img;
import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;
import static org.patternfly.components.Card.header;
...
Card card = card()
        ...
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,Jt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;
import static org.patternfly.components.Card.header;
...
Card card = card()
        ...
        .add(body().textContent("Body"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,$t=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.header;

Card card = card()
        .add(header().textContent("Header"))
        .add(body().textContent("This card has no footer"));`,Zt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;

Card card = card()
        .add(body().textContent("This card has no header"))
        .add(footer().textContent("Footer"));`,Qt=`import static org.patternfly.components.Card.body;
import static org.patternfly.components.Card.card;
import static org.patternfly.components.Card.footer;
import static org.patternfly.components.Card.header;
...
Card card = card()
        .add(header().textContent("Header"))
        .add(body().textContent("Body"))
        .add(footer().textContent("Footer"));`,Xt=`import static org.elemento.Elements.uniqueId;
...
Button add = Button.link(icon(fas("plus-circle")), "Add cip")
        .onClick(() -> group.add(chip(uniqueId())));`,ea=`import static org.patternfly.components.Alert.info;
import static org.patternfly.components.AlertGroup.toast;

Chip chip = Chip.chip("Close Me").onClose(() -> toast().add(info("Goodbye")));`,ta=`import static org.elemento.Elements.uniqueId;
import static org.patternfly.components.Chip.chip;
import static org.patternfly.components.ChipGroup.chipGroup;
...
Content content = Content.content()
        ...
        .add(small().textContent(LoremIpsum.paragraphs(3)));`,ia=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Content content = Content.content()
        .add(dl()
                ...
                .add(dd().textContent("A technology to make HTML look better")));`,ra=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Content content = Content.content()
        .add(ol()
                ...
                .add(li().textContent(LoremIpsum.words()))
                .add(li().textContent(LoremIpsum.words()))
                .add(li().textContent(LoremIpsum.words())));`,sa=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
        ...
        .add(ul()
                ...
                .add(li()
                        ...
                        .add(ul()
                                .add(li().textContent(LoremIpsum.words()))
                                .add(li().textContent(LoremIpsum.words()))))
                .add(li().add(LoremIpsum.words())));`,da=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
ContextSelector<String> contextSelector = ContextSelector.contextSelector("Stage")
        ...
        .add(asList("Development", "Staging", "QA", "Production"));`,la=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
ContextSelector<String> contextSelector = ContextSelector.contextSelector("Stage")
        .add(asList("Development", "Staging", "QA", "Production"));`,ca=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
dataProvider.update(repositories()); // sampe data omitted`,ga=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
dataProvider.bindDisplay(dataTable);
dataProvider.update(repositories()); // sampe data omitted`,ha=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
dataProvider.bindDisplay(dataTable);
dataProvider.update(repositories()); // sampe data omitted`,ya=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
dataProvider.bindDisplay(dataTable);
dataProvider.update(repositories()); // sampe data omitted`,wa=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Dropdown<String> dropdown = Dropdown.<String>text("Dropdown")
        ...
        .add("Item 3");
dropdown.getGroup("Group 2").disable("Group 2 item 1");`,Sa=`import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
...
Dropdown<String> icon = Dropdown.<String>icon(icon(fas("th")))
        ...
        .addSeparator()
        .add("Separated Item");
icon.disable("Disabled");`,Ta=`Dropdown<String> kebab = Dropdown.<String>kebab()
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
        .add("Separated Item");
kebab.disable("Disabled");`,Ca=`Dropdown<String> primary = Dropdown.<String>text("Dropdown").primary()
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
        .add("Separated Item");
primary.disable("Disabled");`,Aa=`Dropdown<String> right = Dropdown.<String>text("Dropdown").right()
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
        .add("Separated Item");
right.disable("Disabled");`,La=`Dropdown<String> dropdown = Dropdown.<String>text("Dropdown")
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
        .add("Separated Item");
dropdown.disable("Disabled");`,Da=`Dropdown<String> noText = Dropdown.<String>splitCheckbox()
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
...
Dropdown<String> withText = Dropdown.<String>splitCheckbox("Dropdown")
        ...
        .addSeparator()
        .add("Separated Item");
withText.disable("Disabled");`,xa=`import org.patternfly.components.Dropdown;
...
Dropdown<Color> dropdown = Dropdown.<Color>text("Dropdown")
    ...
    .add(Color.values());`,_a=`Dropdown<String> up = Dropdown.<String>text("Dropdown").up()
        .add("Item 1")
        .add("Item 2")
        .add("Disabled")
        .addSeparator()
        .add("Separated Item");
up.disable("Disabled");`,Ia=`import static org.patternfly.core.Callback.noop;
import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
...
EmptyState large = EmptyState.emptyState(icon(fas("cubes")), "Empty State").large()
        ...
        .secondary("Action area", noop());`,ja=`import static org.patternfly.core.Callback.noop;

EmptyState noResults = EmptyState.noResults(noop());`,Na=`import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;

EmptyState primaryLink = EmptyState.emptyState(fas("cubes"), "Empty State")
        .body("This represents an the empty state pattern in PatternFly 4. " +
              "Hopefully it's simple enough to use but flexible enough to meet a variety of needs.")
        .primary(Button.link("Action button"));`,Ra=`import static org.patternfly.core.Callback.noop;
import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
...
EmptyState small = EmptyState.emptyState(icon(fas("cubes")), "Empty State").small()
        ...
        .secondary("Go here", noop())
        .secondary("In the secondary", noop())
        .secondary("Action area", noop());`,ka="EmptyState loading = EmptyState.spinner();",Ea=`import static org.patternfly.core.Callback.noop;
import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
...
EmptyState emptyState = EmptyState.emptyState(icon(fas("cubes")), "Empty State")
        ...
        .secondary("Go here", noop())
        .secondary("In the secondary", noop())
        .secondary("Action area", noop());`,Oa='Expandable e = Expandable.expandable().textContent("This content is visible only when the component is expanded.");',Ma=`/*
 *  Copyright 2023 Red Hat
 *
 *  Licensed under the Apache License, Version 2.0 (the "License");
 *  you may not use this file except in compliance with the License.
...
Label l1 = Label.label("Compact Label", true);`,Ba=`import static org.patternfly.resources.CSS.fas;
...
MultiOptionsMenu mom = MultiOptionsMenu.icon(fas("sort-amount-down"))
        ...
        .add(new Group<String>("Sort direction")
                .add(new String[] {
                        "Ascending",
                        "Descending"
                }));`,Pa=`import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
...
SingleOptionsMenu<String> som3 = SingleOptionsMenu.plain("Options menu").disable()
        .add(new String[] {
                ...
                "Option 2",
                "Option 3",
        }));`,za=`SingleOptionsMenu<String> som = SingleOptionsMenu.text("Options menu").right()
        .add(new String[] {
                "Option 1",
                "Another option",
                "Last option",
        });`,Fa=`SingleOptionsMenu<String> som0 = SingleOptionsMenu.text("Options menu")
        .add(new String[] {
                "Option 1",
                "Option 2",
                "Option 3",
...
SingleOptionsMenu<String> som1 = SingleOptionsMenu.text("Options menu").disable()
        .add(new String[] {
                ...
                "Option 2",
                "Option 3",
        });`,Ha=`SingleOptionsMenu<String> som = SingleOptionsMenu.text("Options menu").up()
        .add(new String[] {
                "Option 1",
                "Option 2",
                "Option 3",
        });`,Ua=`import static org.patternfly.components.Icon.icon;
import static org.patternfly.resources.CSS.fas;
import static org.patternfly.resources.CSS.util;
...
`,Wa=`import static org.patternfly.resources.CSS.Size.*;
